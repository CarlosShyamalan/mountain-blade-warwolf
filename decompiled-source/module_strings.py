...
strings = [
	...
	("molda_retreat_penel", "Retreat. Deserters and victims will be occurred during retreating."),
	...
	("pickpocket_fail", "Failed to pickpocket. Fortunately , You succeed to run away without being arrested by guard."),

	("pickpocket_succ", "Successful. No one knows."),

	("her_husband_c", "Her spouse appeared!"),

	("tipsrrrr", "You've received additional tips."),

	("tipsrrrr1", "You've received additional tips. Seems to very satisfied."),

	("msg_battle_won2", "Victory"),

	("msg_battle_lose2", "Defeat"),

	("volunteered_for_rev", "You have been trained for fighting. And have experienced many battlefield. It is be helpful to you later."),

	("inherited_for_rev", "You've inherited fief. it is the father's legacy. And have studied military command."),

	("be_adventurer", "You became a wanderer. and you acquired a lot of knowledge about the world."),

	("be_merchant", "Your last goal is money. because money having power."),

	("be_villain", "You are chosen the dark pass. Murder! Death! Kill!"),

	("be_pirate", "The ocean, there are many opportunities. you will catch one of them."),
	...
	("nd_name_153", "Yi Sun-sin Biography"),
	...
	("lib_right2", "Now you can try persuasion to scholars of the academy."),

	("lib_wrong", "Your speculation is wrong."),

	("lib_loc_question", "I should be speculating. The location of this ruins is where?"),

	("arcademy_half", "Can you sure found {s6} {s7}? We are not prefer this category. rewards will be half."),

	("arcademy_norm", "Can you sure found {s6} {s7}? it will be hard job."),
	...
	("ruin_askia_1", "-Muhammad Toure-^^I was not dead yet.  However, this fucking grave is what? it is my grave? Hey! Who are you? Why kill my men?"),

	("ruin_askia_2", "-Muhammad Toure-^^(He fell from the horse.) Oh my back! ...I'll give you this sword. Get away from me. Or fight more?"),

	("ruin_impaler_1", "There are good spear among the belongings of knight."),

	("ruin_impaler_2", "-Light infantry-^^Pagan devil coming! Kill him!"),

	("ruin_impaler_3", "-Knight-^^Kill the infidels!"),

	("ruin_shaver_1", "-Light infantry-^^Help! this crazy man will kill all of us!"),

	("ruin_shaver_2", "-Viking Berserker-^^Do you need shaving? I'll can do it."),

	("ruin_shaver_3", "You have been get an axe from the hand of Viking."),

	("ruin_shiva_blade_1", "-Prajurit-^^Help!"),

	("ruin_shiva_blade_2", "-Pengawal-^^someone has invaded to temple!"),

	("ruin_shiva_blade_3", "-Sais gajah-^^For the God of destroy!"),

	("ruin_shiva_blade_4", "I defeated them all. I found the brilliant sword during exploring."),

	("ruin_sun_blade_1", "-Warrior-^^Help!"),

	("ruin_sun_blade_2", "-Mamluk Swordman-^^Die!"),

	("ruin_sun_blade_3", "I defeated them all. I found the brilliant sword during exploring."),

	("ruin_evil_spirits_armor_0", "-Samurai-^^You can not able to go my back even one footstep!"),

	("ruin_evil_spirits_armor_1", "I defeated Samurai. And, I had remove his armor."),

	("ruin_dracul_armor_0", "-Unknown creature-^^hhjgfdsf1312? dczxrcnhyr!"),

	("ruin_dracul_armor_1", "I defeated Unknown creature."),

	("ruin_warning", "Intruders! Get him!"),
	...
	("kidnap_three", "When she arrives to there, you can catch her."),
	...
	("ply_hp_disp", "--Player HP: {reg8}--"),

	("ply_hp_disp2", "--Final Player HP: {reg8}--(Traits applies)"),
	...
	("need_battle_exp", "Fail: You need Battle Exp {reg8}"),

	("need_adv_exp", "Fail: You need Adventure Exp {reg8}"),

	("adv_skill_limit", "Fail: You reached the limit."),

	("adv_skill_limit_wm", "Fail: Need weapon master skill level 10."),

	("adv_skill_limi_2", "Fail: You can not select any more."),

	("adv_skill_att", "Success: increase skill level."),

	("adv_wp_increase", "Increase the weapon proficiency (25 per point)"),

	("adv_att_increase", "Increase the stat attribute (Max:20)"),

	("adv_increase_logistics", "Increase probability for avoiding disaster(sand storm, severe cold...). Escape probability +6 per point(land). (Max:5)"),

	("adv_increase_navigation", "Increase probability for avoiding disaster(storm). Escape probability +6 per point(land).(sea) (Max:5)"),

	("adv_increase_exploration", "Affect to radius for ruins discovery. and increases probability of clue finding. Defend from Negative event 10% per points. (Max:5)"),

	("adv_increase_persuasion", "Increase persuasion success rate. increases the number of persuasion in meeting.  (Max:5)"),

	("adv_increase_fascination", "For women, Earns more money in prostitution. When the 'body relationship' gets more relation. For man, increases touch chance. (Max:5)"),

	("adv_increase_trade", "Increase profit of trade. increases bribe success rate in meeting. (Max:5)"),

	("adv_increase_tactics", "Increase probability of tactics. Increased 1 damage of troops per 3 point. (Max:7)"),

	("adv_increase_leadership", "Increased Troops HP 3 per 1 point.(Max:7)"),

	("adv_increase_strategy", "Increased success probability of Strategies. (Max:7)"),

	("adv_increase_naval", "Increased battleship HP +15 per point. (Max:7)"),

	("adv_increase_warfighting", "Increased player HP +5 per point (Max:10)"),
	...
	("wm_qst_text_menu_01", "Guild master:^Village women has been kidnapped. We need help of army to rescue those people. If you success, Guild will give to you {reg8} denars. Can you rescue that women?^^(Bandit leader: also, there is another choice.)"),

	("wm_qst_text_menu_02", "Guild master:^There's group of troublesome bandits. They have infested the vicinity of our town and are preying on my caravans. I will pay you {reg8} denar if you hunt down those troublesome bandits. It's dangerous work.^^(Bandit leader: also, there is another choice.)"),

	("wm_qst_text_menu_03", "Guild master:^Actually, I was looking for an able adventurer like you. one of notorious bandit leader has hiding in near the town. They have infested the vicinity of our town and are preying on my caravans. I will pay you {reg8} denar if you success to kill the bandit leader.^^(Bandit leader: also, there is another choice.)"),

	("wm_qst_text_menu_04", "Guild master:^Our caravan has been attacked by bandits. I will pay you {reg8} denar if you hunt down those bandits. It's dangerous work.^^(Bandit leader: also, there is another choice.)"),

	("wm_qst_text_menu_05", "Guild master:^We need a duelist. instead our client. if you have won the duel, I will pay you {reg8} denar. It's dangerous work."),

	("wm_qst_text_menu_07", "Guild master:^Thugs has caused uproar in the tavern. I will pay you {reg8} denar. if you defeat this thugs."),

	("wm_qst_text_menu_08", "Farm is under attack. You can protect the family at home, or fight against bandits by firing arrows. or you can assist to bandits . what is your choice?"),

	("wm_qst_text_menu_09", "Bandit guild leader:^Our client has a grudge against to a noblewoman. He wants that her get punished. It doesn't mean kill. It means that giving to her a 'great shame'. If you success, I will give you {reg8} denars. Can you doing this job ?"),

	("wm_qst_text_menu_10", "Bandit guild leader:^Our client has a grudge against to a tavern master. He wants that her get punished. It doesn't mean kill. It means that giving to her a 'great shame'. If you success, I will give you {reg8} denars. Can you doing this job ?"),

	("wm_qst_text_menu_11", "Bandit guild leader:^Our client want to be fuck with common people like you. If you have doing this job, Guild will give you {reg8} denars. Can you doing this job ? "),

	("wm_qst_text_menu_13", "Bandit guild leader:^Our customers want to kidnap the common woman. The reason, you also know well. Please do not ask me anymore. If you success, Guild will give you {reg8} denars."),

	("wm_qst_text_menu_15", "Bandit guild leader:^Our client has deep resentment to one person. For this job, we need skillful sniper. Do not misunderstand, It is to hurt only the foot without killing. If you success, Guild will give you {reg8} denars. Can you doing this job ?"),

	("wm_qst_text_menu_16", "Bandit guild leader:^Our customers are looking for some jewelry. However, this gem is not dealt by money. if you can steal this gem, Guild will give you {reg8} denars."),

	("wm_qst_text_menu_17", "Guild master:^Actually, We need army to suppress the rebels. They revolted for survival of their own. However, over time, the essence of them was too changed. Now they are just the bandits. I will pay you {reg8} denar if you can hunt down those rebels."),

	("wm_qst_text_menu_18", "Guild master:^Many armed groups have make uneasy atmosphere. please defeated this Armed group. they are not belong to the country. I will pay you {reg8} denar, if you defeat this Armed groups."),

	("wm_qst_text_menu_19", "Guild master:^Actually, I was looking for an able adventurer like you. one of noble Lady has been kidnapped. The kidnappers will kill her, if they look the others. I will pay you {reg8} denar. It's dangerous work."),

	("wm_qst_text_menu_20", "Guild master:^Nomad looters have been loot the our village. We need military help.  I will pay you {reg8} denar if you hunt down those savages."),

	("wm_qst_text_menu_30", "Traders has been attacked by Pirates. If you defeat this pirates, They will pay to you the reward."),

	("wm_qst_text_menu_31", "In our radius, we found merchant ship. If we attacked them, you can looting the cargo of them."),

	("wm_qst_text_succ_01", "Quest Success:^^ Battle exp: {reg17}^ Money: {reg18}^^Guild master:^I heard news about your success. Thank you very much. Please receive promised compensation."),

	("wm_qst_text_succ_02", "Quest Success:^^ Battle exp: {reg17}^ Money: {reg18}^^Bandit guild leader:^Good job. our client also will be pleased."),
	...
	("wm_qst_text_fail_01", "Quest Fail:^^ Debt: {reg19}^^Guild master:^You failed mission. You said that you can succeed..."),

	("wm_qst_text_fail_02", "Quest Fail:^^ Debt: {reg19}^^Bandit guild leader:^You failed mission. Please careful in road at night ."),

	("wm_qst_text_fail_03", "Quest Fail:^^ Debt: {reg19}^^Bandit guild leader:^You've lost the battle ."),

	("wm_qst_text_fail_auto_01", "Quest Fail:^^ Debt: {reg19}^^That you have experienced in the tavern has spread rumors ."),

	("wm_comp_join", "{s11} was join your party."),

	("wm_comp_left", "{s11} has left the party. (various cause: honor too high or low, event, end of standby, etc.)"),

	("wm_qst_assasin_target", "Target: {s15}^Tip: Aim the lower body .^ You need all green message."),

	("wm_pur_book", "Purchased the book."),

	("help_right_click_pre", "Left Click: Description / Right Click: Select"),

	("riot_surrender", "Riot has occurred at {s13}({s11}). and they are surrendered to {s12}."),
	...
	("meeting_opinion_agree", "Agree"),

	("meeting_opinion_disagree", "Disagree"),

	("meeting_opinion_abstention", "Abstention"),

	("what_is_your_op", "What is your opinion?"),

	("troop_faction_change", "{s13} went to the {s12} from the {s11}."),

	("execute_mess", "It has been successfully processed ."),

	("execute_mess_howe", "However, target faction have refused."),

	("suggest_succ", " [Agenda has been accepted]"),

	("suggest_fail", " [Agenda has been rejected]"),

	("suggest_succ_king", "Suggestion was rejected. however, the king have decided to enforce this suggestion."),
	...
	("text_festival", "-Festival^  Riot will calm down (50%)."),
	...
	("need_mapmarker", "         You need to set [MapMarker] correctly. Click right mouse button on the enemy castle."),
	...
	("dip_text_peace", "Peace Treat"),

	("dip_text_nonag", "Non-Aggression Treat"),

	("dip_text_alli", "Military Alliance"),

	("strategic_res", "Strategic Resource"),
	...
	("ship_lost", "You lost ship."),

	("disaster_storm_alonso", "Alonso: you can avoid damage about sea disaster."),

	("logistics_avoid", "Logistics: you can avoid damage about land disaster."),

	("navigation_avoid", "Navigation: you can avoid damage about sea disaster."),

	("disaster_storm", "{s11} has in danger. The storm is coming!!!"),

	("disaster_sand_storm", "{s11} has in danger. The Sandstorm is coming!!!"),

	("disaster_malaria", "{s11} has in danger. Malaria mosquito is a problem."),

	("disaster_fire", "{s11} has in danger. Fire occurred at mountain."),

	("disaster_typhoon", "{s11} has in danger. Typhoon has given much damage ."),

	("disaster_flood", "{s11} has in danger. because of the flood, Much damage will occur ."),

	("disaster_epidemic", "{s11} has in danger. Infectious disease has been epidemic ."),

	("disaster_earthquake", "{s11} has in danger. Earthquake has given the enormous damage ."),

	("disaster_tidal_waves", "{s11} has in danger. Tidal waves cause the casualties of many ."),

	("disaster_coldbringer", "{s11} has in danger. Many casualties occurred in the severe cold ."),

	("disaster_volcano", "{s11} has in danger. Eruption of the volcano has destroyed everything."),

	("disaster_riot", "Riots occurred at  {s11}. Everything is in chaos."),
	...
	("reli_relation_minus1", "1. Over time, Relation(lord, or lady) is reduced."),

	("reli_relation_minus2", "2. If your religion is different from religion of him(or she), it is more reduced.(2x)"),
	...
	("comrade_add", "Your supporter increased."),

	("pirates_name", "Pirates"),

	("bandits_name", "Bandits"),

	("ret_failed", "You failed to withdrawal"),

	("loc_culture_0", "none"),

	("loc_culture_1", "west euro"),

	("loc_culture_2", "mid euro"),

	("loc_culture_3", "north euro"),

	("loc_culture_4", "east euro"),

	("loc_culture_5", "rome"),

	("loc_culture_6", "north africa"),

	("loc_culture_7", "west arab"),

	("loc_culture_8", "east arab"),

	("loc_culture_9", "japan"),

	("loc_culture_10", "joseon"),

	("loc_culture_11", "nomad"),

	("loc_culture_12", "east china"),

	("loc_culture_13", "west china"),

	("loc_culture_14", "east south asia"),

	("loc_culture_15", "india"),

	("loc_culture_16", "australia"),

	("loc_culture_17", "mid america"),

	("loc_culture_18", "south america"),

	("loc_culture_19", "north america"),

	("loc_culture_20", "anatolia"),

	("loc_culture_21", "west africa"),

	("loc_culture_22", "east africa"),

	("loc_culture_23", "north altantic isle"),

	("loc_culture_24", "south africa"),
	...
	("num_won", "Battle Won: {reg11}"),

	("num_lose", "Battle Lose: {reg12}"),
	...
	("under_attackk", "     [ Our castle {s1} has under attack!! ] (Esc)"),

	("attack_targett", "     [ Attack object of Our faction: {s1} ] (Esc)"),

	("catapult_shot_num", "     [ Num of Siege weapon atttack: {reg8}/{reg9} ]"),
	...
	("bt_st_low", "You need more Strategy skill for using this strategy."),
	...
	("bt_st_dontknow", "You need to learning before using terrain strategy."),
	...
	("bt_cantfight", "Battle impossible"),

	("bt_ys_text_surrender", "-Surrender-^Are you sure?"),

	("bt_ys_text_withdrawal", "-Withdrawal-^Are you sure?"),

	("bt_ys_text_duel", "-Duel-^Enemy commander wants duel."),

	("food_loww", "Lack of supplies. (Morale goes down.)"),

	("moral_loww", "Morale too low."),

	("food_compl", "Supply is complete."),

	("main_party_reportt", "       (Army Size: {reg8}   Train: {reg9}   Morale: {reg10})"),
	...
	("escape_succ", "You have succeeded to escaping."),

	("escape_fail", "You failed to escape."),

	("cantfollow22", "Opponent has moving fast. Your army size is too large for tracing them. Small part of army only can participate to battle."),
	...
	("acv_1", "Death of your family has caused^  by {s11}.^You have occupied ^  every land of them for revenge."),
	...
	("expirationday", "Expiration: {reg8} Day"),

	("reports8", "Report: {s8}"),

	("targets8", "Target: {s8}"),

	("rat_food", "Horde of rat have eating your food!!"),

	("cat_kill_rat", "Horde of rat have eating your food!! However, your cat killed rat!"),

	("internal_fight", "Internal conflict has occurred.(Train decrease)(Some of troop died)"),

	("diseases_diar", "Diarrheal diseases has occurs.(Morale decrease)"),

	("diseases_scurvy", "Scurvy diseases has occurs.(Morale decrease)(Some of troop died)"),

	("diseases_juice", "Scurvy diseases has occurs. however, you have the juice. this is will be helpful for cure.."),

	("place_repu_bad", "In this place, your reputation is too bad."),
	...
	("workshop_built", "You owned workshop. this workshop is working by slave. if you fight with bandits and defeated them, 33% of bandits fall to the slave. they are forcibly moved to the workshop."),
	...
	("rellow", "Relation is too low. (need 5)"),

	("is_enemy", "It is owned by enemy."),

	("cur_slave", "Current slave: {reg8}"),

	("bandit_killl", "You defeated enemies."),

	("worklevc", "It is affect to the dying slaves number."),
	...
	("revengeful_set", "{s3} was swear revenge about your doings. if you defeated in battle against to {s3}, and failed to escape, you will die(Game over)."),

	("revengeful_warning", "Enemy commander is one of your foe. if you defeated in battle, and failed to escape, you will die(Game over)."),
	...
	("cla_bonus_0", "-After battle your experience reward will be tripled^-If you have Mercenary Contract, troops wage is zero."),

	("cla_bonus_1", "-You can have one more trade routes.^-buy price will be discount 10%.^-You can use the checkbook."),

	("cla_bonus_2", "-Adventure quest reward is double.^-You can use the coordinate."),

	("cla_bonus_3", "-Recommend to novice-^-You will start have one castle.^-Heavyarmor equip maintained 1000.^-Honor Increase 1 per week."),

	("cla_bonus_4", "-When you perform dishonorable quest, reward is doubled.^-If you looted traders at ground, money of reward will be doubled.^-You can hire Ninja and Hashashin."),

	("cla_bonus_5", "-If you looted traders at sea, money of reward will be doubled.^-Shipwood equip maintained 1000.^-You can hire pirate.^-Battleship spawn +1"),

	("cla_notfit", "Your rank is peasant."),

	("looted_spouse", "----- Your spouse {s7} was taken prisoner. and married with {s8} by force."),

	("ransom_spouse", "----- Your spouse {s7} was taken prisoner. and they want ransom."),

	("ply_castle_fall", "----- Your castle {s9} has fallen."),

	("resp_troop_name", "         Control troop: {s8}  HP: {reg8}"),
	...
	("marker_mess", "Map Marker: {s3}  (It is used to target of 'Holywar' or 'Faction Meeting: attack, capital move'.)"),
	...
	("outlaw_cant_enter_city", "Horde of outlaws cannot go in hostile city."),

	("player_bath_enter", "You can prevent the disease by bathing. (Three months)"),

	("player_bath_alarm", "You have not bathed for three months. The risk of disease increases."),
	...
	("walker_rumor_01", "I do not know anything."),

	("walker_rumor_02", "Don't bothering me."),

	("walker_rumor_03", "I can't. because he is important person."),

	("walker_rumor_end", "I can't. because he is important person."),

	("dontlike_lord_say_01", "Speak. Quickly. until before my patience has run out."),

	("unlike_first_meet_lord_say_01", "Speak. Quickly"),

	("revengeful_lord_say_01", "I have a debt to you. ..I swear. if got a chance, I will kill you."),

	("lady_say_01", "Don't bothering me!"),
	...
	("lady_say_05", "If you think this job is necessary, i'll do. Do not forget that I am not a whore."),

	("lady_say_06", "This is crazy."),
	...
	("lady_respond_01", "Replies: I'm sorry, but seeing an unfamiliar person , it will be scared."),

	("lady_respond_02", "Replies: Do not send these messages to married woman. My husband would get angry."),

	("lady_respond_03", "Replies: I'm glad. You should move to mansion by secretly. avoid gatekeeper."),

	("lady_respond_04", "Replies: Do not. Lots of people today are at home . perhaps we may have a chance to speak more later..."),

	("lady_respond_05", "Replies: Too early . We still do not know each other well . perhaps we may have a chance to speak more later..."),

	("lady_respond_06", "Replies: Are you kidding me? fuck off."),

	("lady_comment_mansion_01", "Did you come today In order to apologize to me?"),

	("lady_comment_mansion_02", "What brings you here today?"),

	("lady_comment_mansion_03", "Now, if you will excuse me..."),

	("lady_comment_mansion_04", "Its good to see you again."),

	("lady_comment_mansion_05", "Did you wanted to see me?"),
	...
	("enemy_alert_04", "Enemy!"),

	("enemy_alert_end", "Enemy!"),

	("desertion_name", "{reg8} {s8} had become deserter."),
	...
	("fugitive_alert", "I suspect behavior of this person ."),
	...
	("charisma_train", "Train: Charisma(Max:40) {reg8} x 2 = {reg9} hours training effect."),
	...
	("farm_def_fail", "You failed to prevent the bandits invasion ."),

	("farm_def_count", "{reg8}/5 The number of bandits who intruded into the farm."),

	("farm_def_leader", "The bandit leader appears. If he died, this invasion is ended."),
	...
	("lord_escape_ply", "{s8} was escape at your cage."),

	("lord_escape_ai", "{s8} was escape at {s9} prison."),

	("bath_esc", "Bath: {reg8} weeks"),
	...
	("attack_esc", "Attack: {s8}"),

	("defence_esc", "Defence: {s8}"),

	("mapmarker_esc", "MapMarker: {s8}"),
	...
	("remaining_month_esc", "Remaining month: {reg8}"),
	...
	("traders_wage_esc", "Traders wage: -{reg8} (w)"),

	("shipwage_esc", "Ship: -{reg8} (w)"),

	("army_wage_esc", "Army wage: -{reg8} (w)"),

	("companion_wage_esc", "Companion wage: -{reg8} (w)"),
	...
	("remain_day_esc", "Remain day: {reg8}"),
	...
	("holywar_declare_s", "-------------Holywar: {s8} factions declare war to {s9} factions. Target: {s10}"),
	...
	("lord_honor_bonus", "Lord Honor bonus: 1"),
	...
	("minimap_rig", "Attack Move (Right Click on minimap)"),

	("minimap_trace", "Trace (Click on enemy army flag)"),

	("minimap_backup", "Backup (Right Click on our army flag)"),
	...
	("need_suggestt", "Need suggest."),

	("agree_agenda", "Agree to this agenda"),

	("disagree_agenda", "Disagree to this agendad"),
	...
	("you_ca_anymore", "You can not try anymore."),

	("persuasion_success", "Persuasion: Success"),

	("persuasion_fail", "Persuasion: Fail"),

	("faction_culture_point_is_low", "Faction Culture point is low (need {reg4})"),

	("face_model_err", "Face Model ON: at rare intervals cause of CTD"),

	("face_model_off", "Face Model OFF"),
	...
	("owned_castle", "Owned Castle"),

	("bcompanion", "-Companion-"),

	("bstatistics", "-Statistics of based on 10000 people"),
	...
	("learn_text_1", "Enemies will be damaged by rockfall."),

	("learn_text_2", "Attack by fire at the forest."),

	("learn_text_3", "Raise the river water levels by destroying the river bank."),

	("learn_text_4", "Hide troops in the forest. receive bonus at night."),

	("learn_text_5", "Lure enemy into the trap."),

	("learn_text_6", "Destroy enemy supplies. Morale Level goes down."),

	("learn_text_7", "Enemy will be confused. Train Level goes down."),

	("learn_text_8", "Open the castle gate by sending spy."),

	("learn_text_9", "Infiltrate to the waterway."),

	("form_text_1", "Attack the side of the enemy . Cavalry will be added."),

	("form_text_2", "Hits the back of the enemy. Cavalry will be added. receive bonus at night."),

	("form_text_3", "Defend, if enemy has 50 percent more than our army, it can use. HP 30 bonus.  Archer will be added."),

	("form_text_4", "Commander HP 1000% increase. 9 squad HP +200. Our troops hp -30."),

	("form_text_5", "This is a tactic of the hammer and the anvil. Cavalry will be added."),

	("form_text_6", "It will attack from all directions of the enemy . Cavalry will be added."),

	("form_text_7", "Our troops cannot runaway. that's all. "),

	("form_text_8", "Defend, if enemy has 50 percent more than our army, it can use. HP 30 bonus.  Archer will be added. can't ride to horse."),

	("e_fief", "-Fief-"),

	("ala_esc", "----------Press ESC key--------"),
	...
	("our_battleshipr", "Our Battleship: {reg8}"),

	("enemy_battleshipr", "Enemy Battleship: {reg8}"),
	...
	("enemy_fall_chaos", "Enemies confused! (Enemy Army 10% Dies.)"),

	("supply_attacked", "Our supplies looted by enemy!!! (Morale level goes down)"),

	("army_confused", "Our troops confused!!! (Train level goes down)"),
	...
	("hire_tip", "1 tier will be switched automatically to this type of troop.^^(Large-scale army only)"),
	...
	("fps_opt", "No drop equipment(for FPS): {reg8}/1"),

	("res_min_lev", "Respawn Troop Min Level: {reg8}"),

	("res_ia", "Respawn: Inf, Arc"),

	("res_io", "Respawn: Inf only"),

	("res_ao", "Respawn: Arc only"),

	("ply_icon_change", "Player map icon change"),

	("landname", "Landscape name: {reg8}/1"),

	("mapscore", "Mini map score: {reg8}/1"),

	("bannermod", "Modify your banner"),

	("renamefac", "Rename Your Faction"),

	("plycolorchange", "Player color change"),

	("religion_abandon", "Abandon the religion"),

	("opt_face_and_gender_change", "Appearance change"),

	("opt_army_resp_time", "Army respawn number: {reg8}"),
	...
	("disp_ally_enemy", "Ally {reg11}%  -  Enemy {reg12}%"),

	("kill_e_leader", "Enemy leader {reg15} kill"),

	("kill_e_inf", "Enemy infantry {reg19} kill"),

	("kill_e_arc", "Enemy archer {reg20} kill"),

	("kill_e_cav", "Enemy cavalry {reg21} kill"),
	...
	("ad1184_t", "Wolf and Lion"),

	("ad1573_t", "Age of Exploration"),

	("admixed_t", "Twisted Time"),
	...
	("l_briver", "You learned new tactics: River of behind"),
	...
	("battle_st_count_mess", "Player:{reg11} vs Enemy:{reg12}"),
	...
	("married_with_s", "{s6} was get married with {s5}."),
	...
	("diseases9", "{s9} has been suffered from Disease."),

	("gonorrheas9", "{s9} has been suffered from Gonorrhea."),
	...
	("status_changed1", "{s9} status changed (to Light wounds)"),

	("status_changed2", "{s9} status changed (to Medium wounds)"),

	("status_changed3", "{s9} has been recovering from posion."),

	("status_changed4", "{s9} has been recovering from disease."),

	("status_changed5", "{s9} has been recovering from Gonorrhea."),

	("naval_mouse", "Mouse wheel: Weapon switch Melee/Range"),

	("poli_tex", "Collecting the additional taxes. There is a possibility that the riot occurs."),

	("poli_conscription", "Do the forced conscription in all cities. There is a possibility that the riot occurs."),

	("poli_festi", "Festival. Riot will calm down (50%)."),
	...
	("king_war_start", "It is a disgrace choice . however this is the decision of the king ."),

	("start_war_ala_1", "About your surprise attack , your country has been puzzled . However , the country decided to support you .."),

	("start_war_ala_2", "Your raid was considered a crime . your country was tracking you."),

	("start_war_ala_3", "Your raid was considered a crime .Your country gave up you ."),

	("nobelong", "There is no faction that you belong."),

	("ply_assitant_lord", "{s8}: {playername}, I reached for support you."),
	...
	("coup_step_1", "You have stormed the capital in order to win power!!"),

	("coup_step_2", "You have won the battle. however. enemy assistance army was came and surrounding the castle."),

	("coup_step_3", "You have won the battle. and finaly, your supporters had attacked the remaining troops."),
	...
	("debrif_retreat", "Battle Result: Player Retreat"),

	("debrif_ai_retreat", "Battle Result: Enemy Retreat"),

	("ply_capture_lady", "You captured {s3}."),

	("ply_capture_nego", "Success in the negotiations."),

	("money_too_little", "Your money is too little."),

	("named_pirate_harbor_master_g", "Harbor master :Excellent! We can rest assured. thanks."),

	("named_pirate_harbor_master_b", "Harbor master :What? alright. We will find another person."),

	("trade_guild_master_info", "Trade Guild master: what is town's name?"),

	("duel_win_mess", "You got win a duel. Decrease Enemy morale 50"),

	("duel_lose_mess", "You defeated in duel. Decrease Our morale 50"),
	...
	("pre_tournament", "You are at the tournament. You must prepare yourself."),

	("won_arena", "You have won at the arena."),

	("lose_arena", "You have been eliminated from the arena."),

	("pre_arena", "You are at the arena. You must prepare yourself. it is just practice."),
	...
	("ne1184_fac_kingdom_23", "Castille"),
	...
	("ne1573_fac_kingdom_13", "Ottoman"),

	("ne1573_fac_kingdom_14", "Safavid"),
	...
	("ne1573_fac_kingdom_45", "Native tribe"),

	("ne1573_fac_kingdom_46", "Native tribe"),

	("ne1573_fac_kingdom_47", "Wallachia"),

	("ne1573_fac_kingdom_48", "Moldavia"),

	("ne1573_fac_kingdom_49", "Arab tribe"),
	...
	("town_equip_1", "Onehand: +1 dmg per 100"),

	("town_equip_2", "Twohand: +1 dmg per 100"),

	("town_equip_3", "Polearm: +1 dmg per 100"),

	("town_equip_4", "Bow: +2 dmg per 100"),

	("town_equip_5", "Crossbow: +2 dmg per 100"),

	("town_equip_6", "Arquebus: +2 dmg per 100"),

	("town_equip_7", "Ammo: Ammo +2 per 100"),

	("town_equip_8", "Light Armor: +5 HP per 100^(Arc or 1~3t Inf and 4t Cav)"),

	("town_equip_9", "Heavy Armor: +6 HP per 100^(4~6t Inf and 5~6t Cav)"),

	("town_equip_10", "Horse Armor: +8 HP per 100"),

	("town_equip_11", "Siege Weapon: +Ram speed +Split dmg"),

	("town_equip_12", "Tough wood: Ship HP +20 per 100"),

	("town_equip_13", "Ship Ammo: Ship Ammo +1 per 100 "),

	("bt_equip_1", "Onehand: {reg8}"),

	("bt_equip_2", "Twohand: {reg8}"),

	("bt_equip_3", "Polearm: {reg8}"),

	("bt_equip_4", "Bow: {reg8}"),

	("bt_equip_5", "Crossbow: {reg8}"),

	("bt_equip_6", "Arquebus: {reg8}"),

	("bt_equip_7", "Ammo: {reg8}"),

	("bt_equip_8", "Light Armor: {reg8}"),

	("bt_equip_9", "Heavy Armor: {reg8}"),

	("bt_equip_10", "Horse Armor: {reg8}"),

	("bt_equip_11", "Siege Weapon: {reg8}"),

	("bt_equip_12", "Tough wood: {reg8}"),

	("bt_equip_13", "Ship Ammo: {reg8}"),

	("need_int_exp", "Need Policy Exp 400"),

	("need_int_attri", "Need Intelligence (8 per skill)"),

	("slut_commander", "You are a complete slut. You had to devote everything to the soldiers. and now, you are called the great slut."),

	("slut_commander_bo", "Bonus: Your pussy resilience is not down to below 20."),
	...
	("policy_tax_collect_txt", "Each castle tax income +80 dener per skill."),

	("policy_supply_manage_txt", "Number of food storage +10% per skill"),

	("policy_trade_plan_txt", "Caravan income +200 per skill"),

	("policy_frugal_txt", "Army wage decrease -5% per skill"),

	("policy_ship_manage_txt", "Ship maintenance -6% per skill"),

	("policy_lascivious_txt", "Probability of capture about lady +6% per skill"),

	("policy_tracker_txt", "Probability of capture about lord +6% per skill"),

	("town_guide_text_1", "Food: Recruit, Defender regen"),

	("town_guide_text_2", "Produce: Manufacturing time of the equipment"),

	("town_guide_text_3", "Commerce: Faction property, ^Player income = commerce x100(changeable)"),

	("town_guide_text_4", "Culture: policy, holywar.  ^Culture point = culture x35(changeable)"),

	("town_guide_text_5", "Stability: Riot. Raise the defeated kingdom."),

	("town_guide_text_6", "Temple: Time of conversion is half ^(about town religion) "),

	("town_guide_text_7", "Equipment: Affect to Army. ^Added to party per a week"),

	("town_tile_select_equip", "Equipment"),

	("town_tile_select_build", "Building"),

	("town_tile_cantbuild", "It is not possible to build here ."),

	("town_tile_cantremove", "It is impossible."),

	("town_tile_notown", "You are not owner of town."),

	("tile_output_number", "Food:{reg11} / Produce:{reg12}^Commerce:{reg13} / Culture:{reg14}^Stability:{reg15} / Defender:{reg16}"),

	("tutorial_mess_battle", "1. Activate battle menu = [V] key.^2. Auto or charge = [T] key.^3. Click on enemy army flag = Trace.^4. Right Click on our army flag = Backup.^5. Left Click on map = Move^6. Right Click on map = Attack move^(Skip battle: Tab)"),

	("tutorial_mess_battle1", "       1. Activate battle menu = [V] key."),

	("tutorial_mess_battle2", "       2. Auto or charge = [T] key."),

	("tutorial_mess_battle3", "       3. Click on enemy army flag = Trace."),

	("tutorial_mess_battle4", "       4. Right Click on our army flag = Backup."),

	("tutorial_mess_battle5", "       5. Left Click on map = Move"),

	("tutorial_mess_battle6", "       6. Right Click on map = Attack move"),

	("we_know_start", "-----Someone have very strong grudge about you."),

	("cla_req_ala", "Requirement for next step: {s10}{s11}"),
	...
	("cla_req_ala_fuck", "Num of Fucked"),

	("mq_s9", "        {s9}"),

	("mq_s9b", "        And it is necessary the time flow of uncertain amount."),

	("mq_camp_menu_tip_ala", "-------Tip: See the camp menu. and click [main quest tip]"),

	("mq_day_remain", "        it need term of {reg8} days"),

	("mq_1_1", "you were always roaming around town.  because you want to finding  your last family member.^you are walking around the country you were born. frequently, source of important information is always tavern masters."),

	("mq_1_1m", "I need to talk with tavern keepers"),

	("mq_1_1b", "        You need to talk with tavern keepers. at your starting faction castle."),

	("mq_1_2b1", "       1. You need to set correctly 'map marker'."),

	("mq_1_2b2", "       2. click right button on the '{s12}' castle, and select -map marker-"),

	("mq_1_2b3", "       3. and Talk with lords of your start faction about your sister."),

	("mq_1_2bb", "Talk with lords of your start faction about your sister.^TIP: Right click on castle->People Info->Click location name"),

	("mq_1_3b", "        Wait until the results come out. ({reg8} days remain)"),

	("mq_1_3", "Messenger brought a letter to you.^'Our troops have freed our civil from slavery.^however, your sister is not among in them.^So we have tortured the slave traders. And he confessed that your sister was sold to {s12}. He don't know about detailed location.^we expect that information is useful to you.'"),

	("mq_1_3m", "I will going to the town of {s10}"),

	("mq_1_4b", "        Please go to town of {s12}. and collect information from the villagers(in street)."),

	("mq_1_5b", "        Go to the tavern of {s12}. and talk with Ransom Broker."),

	("mq_1_6b", "        Buy the [Fish] in harbor tradeport. and Go to the tavern of {s12}. talk with Ransom Broker."),

	("mq_1_6", "You spread the book, and saw the slaves buyer list.^Although many names, just one name is attracts your attention.^    Higma^ Considering time, this is clear that name is buyer. ^ Fortunately, he have a base in near of the this town."),

	("mq_1_7b1", "       1. Go to the near town."),

	("mq_1_7b2", "       2. Click [War prepare] or [Recruit]"),

	("mq_1_7b3", "       3. Recruit troops up to 3000."),

	("mq_1_7b4", "       4. Go to the bandit fort of {s12}"),

	("mq_1_7", "You saw the fort of the bandits who notorious in this place.^you can't approach to them without army.^"),

	("mq_1_7m", "Attack to the bandits fort"),

	("mq_1_7n", "You need army of 3000 or higher. Please recruiting troops in the town."),

	("mq_higma_fort_name", "Higma's Fort"),

	("mq_1_8", "you have won battle against bandits.^however, your sister is not among in them. ^You got the information by questioning the thieves.^my sister was sold to {s10} trade guilds."),

	("mq_1_8m", "I need to talk with {s10} traders."),

	("mq_1_8b", "        I need to talk with {s12} traders."),

	("mq_1_8n", "Master: If you are being our customer, we will be able to talk about these slaves.^(master wants that you have contract with traders group.)"),

	("mq_1_9b", "        I must conclude a contract with trader."),

	("mq_1_9_1", "       1. Click right mouse button on the any castle"),

	("mq_1_9_2", "       2. Select -Trade route A-"),

	("mq_1_9_3", "       3. Click right mouse button on the another castle"),

	("mq_1_9_4", "       4. Select -Trade route B-"),

	("mq_1_9_5", "       5. Going to trader guild ({s10})"),

	("mq_1_9_6", "       6. Click [Contract with Traders group]"),

	("mq_1_9_7", "       7. Click [Traders Group A] (5000d)"),

	("mq_1_10", "Master: oh. now you are our customer. welcome.^I know what you want. You are looking for your last family member.^What I know is this, she was sold to arab scholar of {s10}."),

	("mq_1_10m", "I will going to the  academy of {s10}"),

	("mq_1_10b", "        I will going to the academy of {s10}. and talk with scholar, about my sister."),

	("mq_1_11b", "        I need to going to the library to find clue in the book."),

	("mq_1_11b1", "      1. Going to library in the castle"),

	("mq_1_11b2", "      2. Click the name of book. 'desert fortress'"),

	("mq_1_11b3", "      3. Pick one of five answer, shown on the right."),

	("mq_1_11b4", "      4. if you had succeeded to picking 'right answer', go back to the academy."),

	("mq_1_11r", "NE Qazvin"),

	("mq_1_11r2", "{s45} was a mountain fortress located in ??? region in the South Caspian province of Daylam near the Rudbar region in persia, approximately 100 km (60 mi) from Tehran. The name means Eagle's Nest"),

	("mq_1_11t", "Desert fortress"),

	("mq_1_12b", "      Go back to the academy of {s10}."),

	("mq_1_13b", "        Find the ruins. It is placed North-East of Qazvin. See the adventure archive of Escape menu"),

	("mq_1_13n", "Alamut fortress"),

	("mq_1_14", "You found Alamut fortress. You feel a sense of unknown threats. You had stumbled backward. There are something on your feet."),

	("mq_1_14m", "Pick up the necklace."),

	("mq_1_15b", "        Report to academy of {s10}."),

	("mq_1_16b", "        Going to Triangular Roof. it is close to {s10}."),

	("mq_1_16", "Scholar said to you that this place is something suspicious.^However, this place is filled with the sounds of lewd women.^This is arguably the prostitution house."),

	("mq_1_16m", "Enter a building."),

	("mq_1_16y_pre", "hey! get outta here! you... you!"),

	("mq_1_16sp_name", "Triangular roof"),

	("mq_1_18", "You were stunned by the attack of the enemy. ^When you regained consciousness, Your sister has disappeared again.^You were desperate to collect information.^It seems one thing has become clear.^She was sold to another place."),

	("mq_1_18m", "I wish I could find her again."),

	("mq_1_19", "You received a letter.^'I heard accidentally about your sad story.^Maybe the information that I have will be helpful to you.^If you want to see me, you should come to the {s10}.^Then, You can see me at the tavern.^-{s14}-'"),

	("mq_1_19m", "Going to Tavern of {s10}, meet with {s14}"),

	("mq_1_20b", "        Going to Tavern of {s10}. and talking with information giver {s14}."),

	("mq_1_21", "{s14}, This man had an information about your sister.^so you followed his back.^You arrived in a dark alley. and you think that something was dangerous."),

	("mq_1_21m", "Those people are what?"),

	("mq_1_23", "This is a trap. someone had wants kill me. However, I was overcome it.^{s14} said, he didn't know that they try to kill you.^His mission is to bring you to this place.^He helped me. So I will forgive him."),

	("mq_1_24", "This is a trap. someone had wants kill me. I fell in vain.^However, {s14} was helped me, and I survived.^{s14} said, he didn't know that they try to kill you.^His mission is to bring you to this place.^He helped me. So I will forgive him."),

	("mq_1_23m", "Accept him as a companion"),

	("mq_1_25", "One day, a caravan trader tell to you.^'Be careful. Group of bandits has chasing your back.'^^You should prepare against to them."),

	("mq_1_25m", "I have to prepare the army."),

	("mq_1_26", "information of trader was right. troops of bandits are gathered in front of your eyes . possibility of retreat is too low."),

	("mq_1_26m", "prepare the battle."),

	("mq_1_26b", "      You should be prepared about attack of unknown."),

	("mq_1_27", "You defeated the enemy. those bandits were people you know. they wanna to revenge. about your attack of before. Maybe, you will be have to destroy bandits bases again."),

	("mq_1_27m", "We need to rest for awhile."),

	("mq_1_28", "You have been fully prepared. and now, you will be have to find bases of bandits. Of course, this is need to recruiting an army.^you should to talk with traveler of tavern. they are source of information."),

	("mq_1_28m", "talk with traveler of tavern"),

	("mq_1_29b", "      talk with traveler of tavern. about bandits bases."),

	("mq_1_30b", "      Going to Tavern of {s10}, meet with {s14}"),

	("mq_1_31b", "        Going to bandits fort. it is close to {s10}."),

	("mq_1_31", "These enemies are too familiar to you. You should destroy them all. Otherwise, you will be chased again by them."),

	("mq_1_31m", "Attack to the bandits fort"),

	("mq_1_32", "bandits have been completely eradicated. You found the prison during rid of the remnants of the enemy.^in the prison, there are one female prisoner. She looked very unstable.^You asked her name.^She replied that '{s14}'."),

	("mq_1_32m", "leaving at the prison with {s14}."),

	("mq_1_33", "While when you rest, you have ominous feeling. Surroundings too quiet. After a while, You saw a stranger, they are dressed black."),

	("mq_1_33m", "Defend myself"),

	("mq_1_35", "You had overcome the attack of assassins.^You should be worried. What is the intention of this attack?"),

	("mq_1_36", "You had almost lost consciousness. and, you've heard scream of someone. Because those screams, you could barely survive.^You should be worried. What is the intention of this attack?"),

	("mq_1_37m", "Talk with Investigator"),

	("mq_1_37", "unknown man appeared. he was introduce himself as Investigator. He wants to talk with you."),

	("mq_1_40", "You had overcome the attack of assassins.^You are worried about the attack will be continued or not."),

	("mq_1_41", "You had almost lost consciousness. and, you've heard scream of someone. Because those screams, you could barely survive.^You are worried about the attack will be continued or not."),

	("mq_1_42", "One day, a caravan trader tell to you.^'in the past, I received secretly a paper from girl. if content of this paper is correct, the recipient will probably be you.'^^'dear {playername}^I heard that from slave trader. I will be sold to the noble mansion of Munich."),

	("mq_1_42m", "Going to mansion of Munich."),

	("mq_1_43b", "      Going to mansion of Munich."),

	("mq_noble_mansion", "Noble mansion"),

	("mq_1_43", "You arrived at the mansion of the nobility. You should make sure that your sister here.^two soldiers had guarding the entrance to the mansion.^You decided to infiltrate secretly in the night."),

	("mq_1_43m", "infiltrate secretly in the night."),

	("mq_1_44y_pre", "(You have infiltrate to mansion. You have been wandering awhile, but eventually found her.)"),

	("mq_1_45", "One day, You heard the screams of a woman. This scream is coming from near old fortress. "),

	("mq_1_46", "You heard screams of woman in this fort. The interior of the fortress will be lurking danger."),

	("mq_1_46m", "approach to old fortress."),

	("mq_old_fort", "Old fortress"),

	("mq_lady_vill", "Village of {s14}"),

	("mq_1_47b", "      Going to Village of {s14}"),

	("mq_1_47m", "Kill them all!"),

	("mq_1_47", "This village was already occupied by the deserters."),

	("mq_1_48", "Your army has fought against deserters and killed them all.^{s14} seems to have impressed about it."),

	("mq_1_48m", "talk with {s14}"),

	("mq_1_49", "Letters came from your sister. She is hoping that you will visit again. You also felt the needs to do so."),

	("mq_1_50", "You arrived at the mansion of the nobility. In this time, you can enter to the front door in legally."),

	("mq_1_50m", "talk with little sister"),

	("mq_1_50y_pre", "Thank you for visit again {playername}."),

	("mq_sis_ord_talk", "How are you doing?"),

	("mq_1_51", "You received a letter from sister.^Dear {playername}^Do you still travel all the world? In my opinion, You seem to need some time to settle. anyway, There is a story that attracts your interesting.^Have you heard about 'Prester John'? He is king of Nestorian Christian kingdom. My husband said to me, if we find kingdom of Prester John, His powerful army will be ally of Christians. In my think it is really interesting legend.^......^I hope you always stay healthy."),

	("mq_1_51m", "I will try to find the clue of prester john."),

	("mq_1_52b", "       Talk with traveler of tavern about prester john"),

	("mq_1_53b", "       Going to the Tola. and Talk with traveler of tavern about prester john"),

	("mq_1_54", "You found the clue of prester john. He is one of powerful warlord of meadows, Ong khan."),

	("mq_1_54m", "Talk with Ong khan of Khereid"),

	("mq_1_55", "You have tried, but the result is not good. I must notify the results to sister by letter."),

	("mq_1_55m", "Send the letter"),

	("mq_1_56", "You received a letter. There is nothing any name. ^'You have been deluded.'"),

	("mq_1_57", "Great landowner of {s10} has sent to you a letter.^'Rebels of {s10} has located at outskirts. They killed innocent citizens who oppose to them.'"),

	("mq_1_57m", "Going to {s10}"),

	("mq_1_58b", "     Going to {s10}. and Attack the rebels."),

	("mq_fort_rebel", "Fort of rebels"),

	("mq_1_58m", "Attack the rebels"),

	("mq_1_58", "You arrived in the rebel fort."),

	("mq_1_59", "You had to repel the rebels. You had captured their leader, and talk with him for last."),

	("mq_1_59m", "Talk with rebel leader"),

	("mq_1_60", "You had to go to {s10} to receive compensation from landowner. And you need to question about crime of landowner."),

	("mq_1_60m", "Talk with landowner"),

	("mq_1_61", "You received a letter from sister.^Dear {playername}^'I have received your reply well. Thank you for your efforts. but we have one more information.^that is Christian kingdom has existed in the Africa.^Maybe, Some people in Africa has know about it.'"),

	("mq_1_61m", "Talk with traveler in africa"),

	("mq_1_62b", "     Going to tavern of africa. and talk with traveler."),

	("mq_1_63b", "     Going to Massawa harbor."),

	("mq_1_64", "You were trying to get information from an old man.^^Oldman: Of course, Christian kingdoms was existed in near of this  place. But now, the kingdom is under attack by Islamic army. Our kingdom is verge to destroying.^^Even now, the Islamic armies were attacking this place."),

	("mq_1_64b", "     Defend Massawa harbor against Islamic army."),

	("mq_1_64m", "Defend Massawa harbor"),

	("mq_1_65", "You defeated the Islamic army^^Oldman: I should be mourn to the dead soldiers of your army. thank.^We have overcome the crisis, but the kingdom is still weak. It cannot be kingdom of prester john. Sorry.^^you must notify the results to sister by letter."),

	("mq_1_65m", "Send the letter"),

	("mq_1_66", "You received a letter. There is nothing any name.^^'If you want to know about your real enemy, come to abadan harbor.'"),

	("mq_1_66m", "Going to abadan harbor."),

	("mq_1_67b", "     Going to abadan harbor."),

	("mq_1_68mess", "     No one approach to you. letter is lying? or any other reason? You had to give up contact with the sender."),

	("mq_1_69", "When you alone, Someone has appeared to your front. He was an Arab man. He seemed to have said to you."),

	("mq_1_69m", "Talk with the unknown man"),

	("mq_1_70", "Investigator has trying to talk with you."),

	("mq_1_70m", "Talk with Investigator"),

	("mq_1_71", "You received a letter from sister.^Dear {playername}^'I have received your reply well. Thank you for your efforts. I have one of good news. I'm pregnant! when you come later, you can see my baby.'"),

	("mq_1_72", "a Beggar has appeared from far away. He said that there is a need to talk with you."),

	("mq_1_72m", "Talk with Beggar"),

	("mq_1_73", "There is trails of destruction and carnage. You decided to take a look at the interior.^^(SYSTEM: this is need video option 'number of corpses' 10 or higher.^If you're not, you have wait until 90 second.)"),

	("mq_1_73m", "entrance the interior"),

	("mq_1_73b", "     Going to mansion of the nobility"),

	("mq_1_74", "You have found the body of your sister. Even she has been pregnant.^You had been being freeze for several hours.^^After you regain your spirit, You have looked the dead corpus for finding clues about the enemies.^Most of the equipments are useless mundane things.^However, one sword caught your eye."),

	("mq_1_74m", "Obtain information from Tavern."),

	("mq_1_75b", "     Obtain information from Tavern."),

	("mq_1_76", "You know that murderer of your sister is hashashin.^but it is too little that known about them.^Anyway, they are belong to arab culture, Perhaps you will be find clues from Arab warlords."),

	("mq_1_76m", "Talk with Arab warlords"),

	("mq_1_77b", "     Talk with Arab warlords. about hashashin."),

	("mq_1_78b", "     talk with scholars about the book of hashashin base."),

	("mq_1_79b", "     Going to alamut castle. this is will be needed army."),

	("mq_1_79", "You arrived at Alamut fortress.^Surprisingly, they are already preparing the army.^It is not situation that requires talk."),

	("mq_1_79m", "Prepare the battle"),

	("mq_1_80", "Enemy first army was defeated. However, enemy has still holds more troops. You cannot win next battle now.^^Now you must retreat for the future."),

	("mq_1_80m", "Withdraw troops."),

	("mq_1_81", "your army can't defeat all hashashins. You need more army that can support you.^They have many enemies at the arab culture. or Catholic^"),

	("mq_1_81m", "Talk with warlords in arab or catholic."),

	("mq_1_82b", "       talk with warlords in arab or catholic."),

	("mq_1_83b", "       talk with grand master of knights templar. at the Cyprus"),

	("cyprus_fort_n", "Knights Templar"),

	("mq_1_83", "It is stronghold of the Knights Templar. In order to receive their support, you need to talk with the Grand Master."),

	("mq_1_83m", "Talk with Grand Master."),

	("hidden_cathedral", "Hidden Cathedral"),

	("mq_1_84b", "       you must find relics of Jesus. it is will be located to near of genoa."),

	("mq_1_85", "It is the old cathedral. Many people gather in front of that. Those people are talking about the relics of the miracle.^They argued that it was Jesus' clothes.^You have to think that it is an absurd claim.^Anyway, You need to report to grand master."),

	("mq_1_85m", "You found Shroud of Jesus"),

	("mq_1_86b", "       You need to report to grand master."),

	("mq_1_86", "It is stronghold of the Knights Templar. You should report to grand master about Shroud of Jesus. "),

	("mq_1_87b", "       Persuade two warlords."),

	("mq_1_87", "You have completed the preparation of war.^Now, you must leading army to the Alamut fortress.^The Knights Templar are waiting there."),

	("mq_1_88", "At last, you've reached this place. The Knights Templar were waiting for you there.^After couple hours, Two warlord has arrived for assist you.^Now is the time to finish everything."),

	("mq_1_88m", "Prepare the battle"),

	("mq_1_88b", "       Going to alamut fortress. Destroy all enemies."),

	("mq_1_89", "You have won the field battle. Enemies have prepared against the siege in the fortress."),

	("mq_1_89m", "Prepare the siege"),

	("mq_1_90", "The fortress completely occupied. Knights templar has slain brutally every hashashin.^Your foe became corpse. But your mind is empty.^^One kinds of thoughts did not leave your head.^Why these things be started?"),

	("mq_1_91", "Your sister's death? or the Necklace?^You were tortured all enemies. But no one knew of the existence of necklaces.^Why these things be started?^^Eventually you finished revenge. But You did not receive any clarification."),

	("mq_1_92", "Anyway, The Knights Templar had withdrawn after the end of the massacre.^Fortress was no longer present."),

	("mq_1_93", "You received a letter. There is nothing any name.^^'If you want to know that your own is how stupid, Go to the 'Triangular inn' at outskirts of Antioch.'"),

	("mq_1_94b", "       Going to Triangular inn at outskirts of Antioch."),

	("mq_1_94", "The inn is quiet as there are no customers. You have worried that there may be a trap.^however, You did not throw away the craving about suspicion for a long time ."),

	("mq_1_94m", "Enter the inn."),

	("triangular_inn", "Triangular inn"),

	("mq_1_96", "Husband of my sister was alive. And now there is a dead body in front of you.^You fell into extreme chaos.^^Sender of nameless letter, he could talk to you about this misery.^But you don't know who is."),

	("mq_1_97m", "Main Quest part 1 ended."),

	("mq_update_later", "Main Quest part 1 ended. part 2 is will be updated later."),

	("mod_name_card", "Warwolf"),

	("main_screen_menu_line", "v0.8312^ferdorgera.blogspot.ru"),
