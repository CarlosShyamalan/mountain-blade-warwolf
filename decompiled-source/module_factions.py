...
factions = [
	...
	("commoners", "Commoners", 0, 0.1, [("player_faction",0.10),("outlaws",-0.60),("undeads",-0.70)]),

	("outlaws", "Outlaws", 0, 0.5, [("kingdom_16",-0.05),("nomad_people",-0.05),("kingdom_54",-0.05),("kingdom_15",-0.05),("kingdom_18",-0.05),("kingdom_30",-0.05),("kingdom_40",-0.05),("player_faction",-0.15),("kingdom_10",-0.05),("kingdom_49",-0.05),("africa_people",-0.05),("kingdom_31",-0.05),("kingdom_36",-0.05),("kingdom_12",-0.05),("kingdom_19",-0.05),("kingdom_60",-0.05),("kingdom_35",-0.05),("kingdom_66",-0.05),("player_supporters_faction",-0.08),("kingdom_56",-0.05),("kingdom_53",-0.05),("kingdom_20",-0.05),("kingdom_59",-0.05),("indochina_people",-0.05),("american_native",-0.05),("mid_euro_people",-0.05),("arabian_people",-0.05),("kingdom_25",-0.05),("kingdom_5",-0.05),("kingdom_38",-0.05),("china_people",-0.05),("kingdom_24",-0.05),("kingdom_63",-0.05),("east_euro_people",-0.05),("kingdom_3",-0.05),("kingdom_26",-0.05),("kingdom_22",-0.05),("kingdom_33",-0.05),("kingdom_62",-0.05),("kingdom_14",-0.05),("kingdom_48",-0.05),("kingdom_61",-0.05),("kingdom_65",-0.05),("kingdom_44",-0.05),("kingdom_57",-0.05),("kingdom_43",-0.05),("kingdom_11",-0.05),("kingdom_50",-0.05),("kingdom_8",-0.05),("kingdom_45",-0.05),("kingdom_28",-0.05),("kingdom_1",-0.05),("kingdom_32",-0.05),("kingdom_41",-0.05),("kingdom_34",-0.05),("japan_people",-0.05),("kingdom_4",-0.05),("kingdom_47",-0.05),("hindu_people",-0.05),("kingdom_55",-0.05),("kingdom_9",-0.05),("kingdom_29",-0.05),("kingdom_17",-0.05),("kingdom_58",-0.05),("kingdom_6",-0.05),("kingdom_64",-0.05),("kingdom_39",-0.05),("kingdom_27",-0.05),("kingdom_2",-0.05),("kingdom_21",-0.05),("kingdom_37",-0.05),("kingdom_52",-0.05),("kingdom_7",-0.05),("kingdom_23",-0.05),("kingdom_51",-0.05),("kingdom_13",-0.05),("kingdom_46",-0.05),("pioneers",-0.05),("kingdom_67",-0.05),("commoners",-0.60),("kingdom_42",-0.05)], [], 0x00888888),
	...
	("player_faction", "Player Faction", 0, 0.9, [("outlaws",-0.15),("player_supporters_faction",1.00),("undeads",-0.50),("commoners",0.10)], [], 0x00706d5a),
	...
	("kingdom_2", "Macedon", 0, 0.9, [("outlaws",-0.05)], [], 0x005ad2f1),
	...
	("kingdom_6", "Kingdom of Jerusalem", 0, 0.9, [("outlaws",-0.05)], [], 0x00fcfbfb),
	...
	("kingdom_11", "German", 0, 0.9, [("outlaws",-0.05)], [], 0x00ffff00),
	...
	("kingdom_26", "Byzantine", 0, 0.9, [("outlaws",-0.05)], [], 0x007b0033),
	...
	("kingdom_30", "Mongol", 0, 0.9, [("outlaws",-0.05)], [], 0x00a33e32),
	...
	("kingdom_50", "American native", 0, 0.9, [("outlaws",-0.05)], [], 0x00b8c0c0),
	...
	("kingdom_55", "Teutonic Knights", 0, 0.9, [("outlaws",-0.05)], [], 0x00dbdbdb),
	...
	("africa_people", "African tribe", 0, 0.5, [("outlaws",-0.05)], [], 0x00a76e32),

	("nomad_people", "Nomad", 0, 0.5, [("outlaws",-0.05)], [], 0x00a28e39),

	("hindu_people", "Hindu tribe", 0, 0.5, [("outlaws",-0.05)], [], 0x0028989b),

	("china_people", "Small faction", 0, 0.5, [("outlaws",-0.05)], [], 0x00b0b286),

	("indochina_people", "Indochina tribe", 0, 0.5, [("outlaws",-0.05)], [], 0x00dcb2c6),

	("arabian_people", "Arabian tribe", 0, 0.5, [("outlaws",-0.05)], [], 0x00b36d19),

	("mid_euro_people", "Euro small faction", 0, 0.5, [("outlaws",-0.05)], [], 0x00fc8800),

	("east_euro_people", "Eastern small faction", 0, 0.5, [("outlaws",-0.05)], [], 0x0093a884),

	("american_native", "American tribe", 0, 0.5, [("outlaws",-0.05)], [], 0x0079ae5c),

	("japan_people", "Small clan", 0, 0.5, [("outlaws",-0.05)], [], 0x0079ae5c),
