...
dialogs = [
	...
	[],
	"Yes master. What can i help?", "hideout_warder_1",
	[]],
	...
	[],
	"Welcome. my master.", "brothel_manager",
	[]],
	...
	"I looked my own pussy.", "cunt_view_self",
	[
		(str_clear, 43),
	...
	"[He was extremely embarrassed.] Why you here?", "mq_94_1",
	[]],
	...
	"You're too late. {playername}. They have already moved to another place.", "mainq_20_1",
	[]],
	...
	"We got so much help from you. You need to receive the rewards about this. ...I will be helpful at your army.", "mainq_48_1",
	[]],
	...
	"I caught you!", "female_ply_raped_1",
	[]],
	...
	"You'll not live long to enjoy your victory. My kinsmen will soon wipe out the stain of this defeat.", "lord_captured_1",
	[]],
	...
	"Finally. I caught you!", "lord_ntr_1",
	[]],
	...
	"Please. plead for your mercy.", "lady_capture_1",
	[]],
	...
	"Greetings.  I am religionist. i will help you.", "religionist_talk",
	[]],
	...
	" Thank you for rescue me. But I worried about our village.", "mq_46_1",
	[]],
	...
	"Thank you for rescue me.  finally, I would be able to going home .", "lady_rescue_1",
	[]],
	...
	"Please do not attack! We are just ordinary people. please have mercy.", "attack_innocent_1",
	[]],
	...
	"W-what are you doing here? damn. I will give the money to you. please don't tell my wife.", "lord_misdoubt",
	[]],
	...
	"Thanks your invitation. Oh, nice mansion.", "lord_talk",
	[]],
	...
	"This will be a great time, thanks.", "close_window",
	[
	...
	"{playername}, Today I want to talk seriously about our relationship.", "lord_propose_to_ply_1",
	[]],
	...
	"(the soldier has staring front.)", "close_window",
	[]],
	...
	"Hey! {playername}. I can not wait for a long time ! To accept me formally, it is need the exclusion of others .", "standby_talk",
	[]],
	...
	"I haven't seen you for a long, What happened?", "ex_lady_rejoin",
	[]],
	...
	"Greetings to you, this Alcohol is shit.", "bard_talk",
	[]],
	...
	"Greetings. If you have any prisoners, I will be happy to buy them from you.", "ransom_talk",
	[]],
	...
	[],
	"Who sent you? I 'll give you money, please do not hurt me! 2,000 denars? 5,000 denars? Yes, I'll give you 10,000 denars!", "insult_woman_mst_talk_1",
	[]],
	...
	[anyone|plyr, "insult_woman_mst_talk_1",
	[],
	"Good. If you give money, you can preserve life.", "insult_woman_gold_1",
	[]],
	...
	"Please forgive me, This is a message of people having grudge to you.", "tavernkeeper_qst_insult_tavern_master",
	[]],
	...
	[],
	"There is no talk with you.", "close_window",
	[]],
	...
	"Hmm. fackable body. first, suck my dick. now.", "woman_player_prosti_talk_1",
	[]],
	...
	[],
	"Uhh! Weird taste. You're feels better now?", "woman_player_prosti_talk_6",
	[]],

	[anyone, "woman_player_prosti_talk_6",
	[],
	"Now shut up! spread your leg! (hit) ", "woman_player_prosti_talk_7",
	[
	...
	"Oh, finally! my handsome guy has coming!", "gay_noble_man_mst_talk_1",
	[]],
	...
	[anyone|plyr, "gay_noble_man_mst_talk_1",
	[],
	"I was mistaken my way. I'm out.", "gay_noble_man_mst_out",
	[]],

	[anyone, "gay_noble_man_mst_out",
	[],
	"Enter is depend your free will. however Exit is not depend your will.", "close_window",
	[
		(assign, "$wm_quest_result", 1),
		(assign, "$mt_action_on", 1),
		(assign, "$g_sex_troop_id", "$g_talk_troop"),
	...
	[anyone, "mq_37_2",
	[],
	"Have you ever met with scholar since then?", "mq_37_3",
	[]],
	...
	[anyone, "mq_37_4",
	[],
	"He died. and people who have received a request from that scholar  also died. In my opinion, You have been fall in dangerous.", "mq_37_5",
	[]],
	...
	[anyone, "mq_37_6",
	[],
	"If you're telling the truth, you are the first survivor. Do you have a clue something from them?", "mq_37_7",
	[]],

	[anyone|plyr, "mq_37_7",
	[],
	"Nothing. wait. if they are have not disguised, they probably were like muslim side.", "mq_37_8",
	[]],

	[anyone, "mq_37_8",
	[],
	"It is too difficult to investigate. anyway, be careful. There is no guarantee that they do not strike twice.", "mq_37_9",
	[]],
	...
	[],
	"Our lord has watching over us. What is your intention?", "pope_talk",
	[]],

	[trp_ex_npc_060, "start",
	[],
	"What is your intention?", "pope_talk",
	[]],
	...
	"I have been working as mercenaries. are you want my assistance?", "mq_30_1",
	[]],

	[anyone|plyr, "mq_30_1",
	[],
	"Yes, however it is different problem.", "mq_30_2",
	[]],

	[anyone, "mq_30_2",
	[],
	"different problem? if you have a grudge against me, i will be say 'please forgive me'.", "mq_30_3",
	[]],

	[anyone|plyr, "mq_30_3",
	[],
	"i'm not have any grudge against you. I merely want the information about horde of mountain bandits.", "mq_30_4",
	[]],

	[anyone, "mq_30_4",
	[],
	"If my guess is right, You have been chased by them. I understood. so what is your next plan?", "mq_30_5",
	[]],

	[anyone|plyr, "mq_30_5",
	[],
	"I want to destroy them all. Even if they are one people alive I can not fall asleep.", "mq_30_6",
	[]],

	[anyone, "mq_30_6",
	[],
	"If so, you should have mercenary contract with me. the contract been signed, i'll tell to you about location of bandits.", "mq_30_7",
	[]],
	...
	[],
	"I'm sick of living here now. I feel trapped in a cage. Someone take out me, it would be nice.", "ex_lady_01_join_4",
	[]],
	...
	[],
	"(Grabbed her hand and quit.)", "ex_lady_01_join_6",
	[]],

	[anyone|plyr, "ex_lady_01_join_5",
	[],
	"(Pay for drink. and go out )", "close_window",
	[]],

	[anyone, "ex_lady_01_join_6",
	[],
	"Aww What are you doing this! (But she is being out ahead of you.)", "ex_lady_01_join_7",
	[]],

	[anyone, "ex_lady_01_join_7",
	[],
	"Somebody help me! Look at this guy!  (She has already beckoning from the door.)", "ex_lady_01_join_8",
	[]],

	[anyone|plyr, "ex_lady_01_join_8",
	[],
	"Oh severe exaggeration. Anyway, let's go.", "ex_lady_01_join_9",
	[
	...
	"Hi! But you are wandering here and there?", "ex_lady_02_join_1",
	[]],
	...
	[anyone|plyr, "ex_lady_02_join_1",
	[],
	"What does it matter with you.", "close_window",
	[]],

	[anyone, "ex_lady_02_join_2",
	[],
	"Mercenary, I need crew.", "ex_lady_02_join_3",
	[]],

	[anyone, "ex_lady_02_join_3",
	[],
	"I was a pirate. being attacked by  'Red Beard', I Lost everything.", "ex_lady_02_join_4",
	[]],

	[anyone, "ex_lady_02_join_4",
	[],
	"But I will rebuild. My skills are going strong.", "ex_lady_02_join_5",
	[]],

	[anyone|plyr, "ex_lady_02_join_5",
	[],
	"It would be good to stop the pirates, you can become a chief mate.", "ex_lady_02_join_6",
	[]],
	...
	[],
	"As you said. i would be nice to being a chief mate.", "ex_lady_02_join_8",
	[]],

	[anyone|plyr, "ex_lady_02_join_8",
	[],
	"Welcome. chief mate.", "ex_lady_02_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	[],
	"Oh, yes. Well, let's.", "close_window",
	[]],
	...
	[],
	"There is no particular say. Is there a bad thing to you?", "ex_lady_03_join_2",
	[]],
	...
	[],
	"There are a lot of bad things. ", "ex_lady_03_join_3",
	[]],

	[anyone, "ex_lady_03_join_3",
	[],
	"I am a fencing instructor. However, it is not any more. Accident occurred during training. The trainee, was killed by stab seriously Trainee other.", "ex_lady_03_join_4",
	[]],

	[anyone, "ex_lady_03_join_4",
	[],
	"I can not do the job anymore.", "ex_lady_03_join_5",
	[]],

	[anyone|plyr, "ex_lady_03_join_5",
	[],
	"I need trainer. You can train my soldiers?", "ex_lady_03_join_6",
	[]],
	...
	[],
	"I happy to accept your offer.", "ex_lady_03_join_7",
	[]],

	[anyone, "ex_lady_03_join_7",
	[],
	"However, do not let to me a strange one. I'm just a trainer.", "ex_lady_03_join_8",
	[]],

	[anyone|plyr, "ex_lady_03_join_8",
	[],
	"Sure. Welcome here. trainer.", "ex_lady_03_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	[],
	"Before you ask, I should introduce myself. My name is Diaochan. Adopted daughter of Minister Wang Yun.", "ex_lady_04_join_3",
	[]],

	[anyone, "ex_lady_04_join_3",
	[],
	"At the request of the father, I was tempted Dong Zhuo and Lu Bu. Eventually Dong Zhuo Assassinated by Lubu. So remnants has been tracking me.", "ex_lady_04_join_4",
	[]],

	[anyone, "ex_lady_04_join_4",
	[],
	"now, I can not escape their pursuit.", "ex_lady_04_join_5",
	[]],
	...
	[anyone|plyr, "ex_lady_04_join_5",
	[],
	"I can not.", "close_window",
	[]],

	[anyone, "ex_lady_04_join_6",
	[],
	"If you could save my life, I will do anything.", "ex_lady_04_join_7",
	[]],

	[anyone, "ex_lady_04_join_7",
	[],
	"This is my ask. I want to hear your thoughts.", "ex_lady_04_join_8",
	[]],

	[anyone|plyr, "ex_lady_04_join_8",
	[],
	"Sure. Welcome here. Chef.", "ex_lady_04_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop"),
	...
	[],
	"Chef? Ok. Nice to meet you.", "close_window",
	[]],
	...
	"Outsider! Do you leave right now?", "ex_lady_05_join_1",
	[]],
	...
	[],
	"Yeah, but what went wrong?", "ex_lady_05_join_2",
	[]],

	[anyone|plyr, "ex_lady_05_join_1",
	[],
	"Can not tell.", "close_window",
	[]],

	[anyone, "ex_lady_05_join_2",
	[],
	"May I join? Quickly Answer me. There is no time.", "ex_lady_05_join_3",
	[]],

	[anyone, "ex_lady_05_join_3",
	[],
	"I want to leave immediately in this fucking home Before parents know. My parents are the ruler of Namman.", "ex_lady_05_join_4",
	[]],

	[anyone, "ex_lady_05_join_4",
	[],
	"I can fight well. I will certainly be of help to you. Did you understand? ", "ex_lady_05_join_5",
	[]],

	[anyone|plyr, "ex_lady_05_join_5",
	[],
	"Fighter is useful. May go together.", "ex_lady_05_join_6",
	[]],

	[anyone|plyr, "ex_lady_05_join_5",
	[],
	"Stay at home.", "close_window",
	[]],

	[anyone, "ex_lady_05_join_6",
	[],
	"Fine.   Oh, I'll have luggage.", "ex_lady_05_join_7",
	[]],

	[anyone, "ex_lady_05_join_7",
	[],
	"(After a while) Done. Now, let's go.", "ex_lady_05_join_8",
	[]],

	[anyone|plyr, "ex_lady_05_join_8",
	[],
	"Sure.", "ex_lady_05_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	"Do you recruit soldier?", "ex_lady_06_join_1",
	[]],
	...
	[],
	"Yeah, Do you know how to fight?", "ex_lady_06_join_2",
	[]],
	...
	[],
	"How to fight? You had ask questions to me, such as other people.", "ex_lady_06_join_3",
	[]],

	[anyone, "ex_lady_06_join_3",
	[],
	"I called the Shieldmaiden. Everyone saying like this, Women are not good at fighting. I'm not.", "ex_lady_06_join_4",
	[]],

	[anyone, "ex_lady_06_join_4",
	[],
	"So, you think?", "ex_lady_06_join_5",
	[]],

	[anyone|plyr, "ex_lady_06_join_5",
	[],
	"There is no prejudice. If you want you can be soldier. Please join.", "ex_lady_06_join_6",
	[]],

	[anyone|plyr, "ex_lady_06_join_5",
	[],
	"Go home, and stay there.", "close_window",
	[]],
	...
	[],
	"You will see my ability, on the battlefield.", "ex_lady_06_join_8",
	[]],

	[anyone|plyr, "ex_lady_06_join_8",
	[],
	"Sure. Welcome.", "ex_lady_06_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	"('Armor-clad women has staring at you.)", "ex_lady_07_join_1",
	[]],
	...
	[],
	"(Speaks) Why are you looking at me?", "ex_lady_07_join_2",
	[]],
	...
	[],
	"What is you party? What do you do?", "ex_lady_07_join_3",
	[]],

	[anyone, "ex_lady_07_join_3",
	[],
	"(Woman observe you) I seem to be misunderstood. Sorry.", "ex_lady_07_join_4",
	[]],

	[anyone, "ex_lady_07_join_4",
	[],
	"I'm being chased. The soldiers make me uneasy.", "ex_lady_07_join_5",
	[]],

	[anyone|plyr, "ex_lady_07_join_5",
	[],
	"That you are armed. If you know how to fight, Come with me.", "ex_lady_07_join_6",
	[]],

	[anyone|plyr, "ex_lady_07_join_5",
	[],
	"I do not want to know.", "close_window",
	[]],

	[anyone, "ex_lady_07_join_6",
	[],
	"I do not understand. I met you the first time.", "ex_lady_07_join_7",
	[]],

	[anyone, "ex_lady_07_join_7",
	[],
	"Damn. I can not judge the situation. Seems to be at least, you're not chaser.  I will go along to you.", "ex_lady_07_join_8",
	[]],

	[anyone|plyr, "ex_lady_07_join_8",
	[],
	"Sure. Welcome.", "ex_lady_07_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	"(Scream.) Help me! Help me! (woman was caught by bully.)", "ex_lady_08_join_1",
	[]],
	...
	[],
	"(You knocked out them.)", "ex_lady_08_join_3",
	[]],
	...
	[],
	"Had the same thing three times this month. Maybe I will have to leave.", "ex_lady_08_join_5",
	[]],

	[anyone|plyr, "ex_lady_08_join_5",
	[],
	"I can help. If you are able to do some work for my army, You can go with us.", "ex_lady_08_join_6",
	[]],
	...
	[],
	"Really? Thanks for your suggestion.", "ex_lady_08_join_7",
	[]],

	[anyone, "ex_lady_08_join_7",
	[],
	"I do not know what to do. but I will work hard.", "ex_lady_08_join_8",
	[]],

	[anyone|plyr, "ex_lady_08_join_8",
	[],
	"Sure. Welcome.", "ex_lady_08_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	"Greetings. Sorry but I don't have time to talk now.", "ex_lady_09_join_1",
	[]],
	...
	[],
	"What's the matter ? maybe i will be helpful to you.", "ex_lady_09_join_2",
	[]],
	...
	[],
	"Have you ever heard the name Alibaba?. I am his servant, Kahramana.", "ex_lady_09_join_4",
	[]],

	[anyone, "ex_lady_09_join_4",
	[],
	"I has freedom now. So i need a bit of money, So, I went to the sesame cave. But here there is nothing. ", "ex_lady_09_join_5",
	[]],
	...
	[],
	"There is no other way. I accept your offer.", "ex_lady_09_join_7",
	[]],

	[anyone, "ex_lady_09_join_7",
	[],
	"I can fight. maybe other a few things too.", "ex_lady_09_join_8",
	[]],

	[anyone|plyr, "ex_lady_09_join_8",
	[],
	"Good. Welcome here.", "ex_lady_09_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	[],
	"I don't know.", "ex_lady_10_join_2",
	[]],
	...
	[],
	"Useless. I was completely tired. I will now stop searching for sister.", "ex_lady_10_join_3",
	[]],

	[anyone, "ex_lady_10_join_3",
	[],
	"Perhaps, she'll be fine.", "ex_lady_10_join_4",
	[]],

	[anyone, "ex_lady_10_join_4",
	[],
	"Or not. I do not care. So, what are you?", "ex_lady_10_join_5",
	[]],

	[anyone|plyr, "ex_lady_10_join_5",
	[],
	"Travelers. Maybe we can help you finding her.", "ex_lady_10_join_6",
	[]],

	[anyone|plyr, "ex_lady_10_join_5",
	[],
	"I hate 'talkative' women. Bye.", "close_window",
	[]],

	[anyone, "ex_lady_10_join_6",
	[],
	"I said. I do not care. 'Find her' is meaningless.", "ex_lady_10_join_7",
	[]],

	[anyone, "ex_lady_10_join_7",
	[],
	"So, your advice is good. Travel. Instead of looking for a crazy woman, at least means.", "ex_lady_10_join_8",
	[]],
	...
	"You there, traveler. hello. I want to leave the town, it would be better if i have companion.", "ex_lady_11_join_1",
	[]],
	...
	[],
	"Why do you want to leave the town?", "ex_lady_11_join_2",
	[]],
	...
	[],
	"My Parents forced me to have an arranged marriage.", "ex_lady_11_join_3",
	[]],

	[anyone, "ex_lady_11_join_3",
	[],
	"It's the royal family. I'm just want like an ordinary people live. and I feel bad dreams last night.", "ex_lady_11_join_4",
	[]],

	[anyone, "ex_lady_11_join_4",
	[],
	"In my dreams. someone has destruct our country and I was being raped. I'm scary. If I marry a royal, this dream seems to be come true.", "ex_lady_11_join_5",
	[]],

	[anyone|plyr, "ex_lady_11_join_5",
	[],
	"Let us together. We can afford that much.", "ex_lady_11_join_6",
	[]],

	[anyone|plyr, "ex_lady_11_join_5",
	[],
	"Women are useless.", "close_window",
	[]],

	[anyone, "ex_lady_11_join_6",
	[],
	"Fine. Before worse situation, let us start.", "ex_lady_11_join_7",
	[]],

	[anyone, "ex_lady_11_join_7",
	[],
	"I can cook. maybe other a few things too.", "ex_lady_11_join_8",
	[]],

	[anyone|plyr, "ex_lady_11_join_8",
	[],
	"Good. Welcome here.", "ex_lady_11_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	"Hey. Stop fighting, and let us talk.", "ex_lady_12_join_1",
	[]],

	[anyone|plyr, "ex_lady_12_join_1",
	[],
	"Talk? There is no need for talk. Die !", "ex_lady_12_join_2",
	[]],

	[anyone, "ex_lady_12_join_2",
	[],
	"Stop! Stop! please.", "ex_lady_12_join_3",
	[]],

	[anyone, "ex_lady_12_join_3",
	[],
	"There is no place to go back. because I failed assassination.", "ex_lady_12_join_4",
	[]],

	[anyone, "ex_lady_12_join_4",
	[],
	" The meaning of this word. Is that I can work for you.", "ex_lady_12_join_5",
	[]],

	[anyone|plyr, "ex_lady_12_join_5",
	[],
	"Good. Do not betray me. If you have betrayed me, I will kill you.", "ex_lady_12_join_6",
	[]],

	[anyone|plyr, "ex_lady_12_join_5",
	[],
	"I don't want people like you. and I'm not going to kill you. get out.", "close_window",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
	...
	[],
	"Thank you. I swear. I will not betray you.", "close_window",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop"),
		(change_screen_return)
	...
	"You. Have you got an army?", "ex_lady_13_join_1",
	[]],
	...
	"(She ignores you.) (need army 8000) (not mori faction)", "close_window",
	[]],

	[anyone|plyr, "ex_lady_13_join_1",
	[],
	"Yes. What has happened?", "ex_lady_13_join_2",
	[]],
	...
	[],
	"I was one of mimura family woman. Unfortunately, Mori family has destroyed our family. All dead except me.", "ex_lady_13_join_3",
	[]],

	[anyone, "ex_lady_13_join_3",
	[],
	"I want revenge. Troops are needed in order to attack them.", "ex_lady_13_join_4",
	[]],

	[anyone, "ex_lady_13_join_4",
	[],
	"If You help me, I'll do anything for you.", "ex_lady_13_join_5",
	[]],

	[anyone|plyr, "ex_lady_13_join_5",
	[],
	"Anything? I want to check your determination. can you give the your body to the soldiers for raising morale?", "ex_lady_13_join_5_1",
	[]],

	[anyone|plyr, "ex_lady_13_join_5",
	[],
	"Heard everything. Good Bye.", "close_window",
	[]],

	[anyone, "ex_lady_13_join_5_1",
	[],
	"I can do it. For revenge.", "ex_lady_13_join_5_2",
	[]],

	[anyone|plyr, "ex_lady_13_join_5_2",
	[],
	"You really has vengeful .", "ex_lady_13_join_5_3",
	[]],

	[anyone, "ex_lady_13_join_5_3",
	[],
	"Are you satisfied? So, Can i use your army?", "ex_lady_13_join_6",
	[]],

	[anyone|plyr, "ex_lady_13_join_6",
	[],
	"There is no other way. Using my army. I will help your revenge.", "ex_lady_13_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	"Oh! I lose control of my horse.", "ex_lady_14_join_1",
	[]],
	...
	[],
	"Thank you. If not have you, I was almost dangerous.", "ex_lady_14_join_3",
	[]],

	[anyone, "ex_lady_14_join_3",
	[],
	" I have to move to avoid the war. My fiance said. 'Do not come back here your life is in danger.'", "ex_lady_14_join_4",
	[]],

	[anyone, "ex_lady_14_join_4",
	[],
	"So, in wandering.", "ex_lady_14_join_5",
	[]],

	[anyone|plyr, "ex_lady_14_join_5",
	[],
	"Let us together. Can we keep at least your life.", "ex_lady_14_join_6",
	[]],
	...
	[],
	"There is no other way. I accept your offer.", "ex_lady_14_join_7",
	[]],

	[anyone, "ex_lady_14_join_7",
	[],
	" It is my first trip. I will probably need to do several things.", "ex_lady_14_join_8",
	[]],

	[anyone|plyr, "ex_lady_14_join_8",
	[],
	"Good. Welcome here.", "ex_lady_14_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	"Oh sir. What do you want.", "ex_lady_15_join_1",
	[]],
	...
	[],
	"I am traveler. My heart goes anywhere.", "ex_lady_16_join_2",
	[]],
	...
	[],
	"I want to be like you.", "ex_lady_16_join_3",
	[]],

	[anyone, "ex_lady_16_join_3",
	[],
	"I have always lived only here, cannot know about the world.", "ex_lady_16_join_4",
	[]],

	[anyone, "ex_lady_16_join_4",
	[],
	"Heard the news that one of my only consolation.", "ex_lady_16_join_5",
	[]],

	[anyone|plyr, "ex_lady_16_join_5",
	[],
	"Let us together. I'll show you the world.", "ex_lady_16_join_6",
	[]],
	...
	[],
	"No. Not this time. I can not go so suddenly.", "ex_lady_16_join_7",
	[]],

	[anyone, "ex_lady_16_join_7",
	[],
	"However, if later time, it is clear that it will be too late. Then I have to go now.", "ex_lady_16_join_8",
	[]],

	[anyone|plyr, "ex_lady_16_join_8",
	[],
	"Good. let us go now.", "ex_lady_16_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	[],
	"Don't look back.  This is the words to myself.", "close_window",
	[]],
	...
	"Excuse me, I have a favor to ask one.", "ex_lady_17_join_1",
	[]],
	...
	[],
	"A few days before my brother was died.", "ex_lady_17_join_3",
	[]],

	[anyone, "ex_lady_17_join_3",
	[],
	"He was murdered. Perhaps recently visited Outsider was kill my brother.", "ex_lady_17_join_4",
	[]],

	[anyone, "ex_lady_17_join_4",
	[],
	"They have already left. I need to chase them. Find them. Will kill them.", "ex_lady_17_join_5",
	[]],

	[anyone|plyr, "ex_lady_17_join_5",
	[],
	"Let's go. Looking for a killer.", "ex_lady_17_join_6",
	[]],
	...
	[],
	"Thank you. In fact, would be difficult to find them.", "ex_lady_17_join_7",
	[]],

	[anyone, "ex_lady_17_join_7",
	[],
	"Although take a long time, I will find them.", "ex_lady_17_join_8",
	[]],

	[anyone|plyr, "ex_lady_17_join_8",
	[],
	"Good. Welcome here.", "ex_lady_17_join_9",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	"Nice to meet you. Sir. Is there anything you need?", "ex_lady_18_join_1",
	[]],
	...
	[],
	"Please join us.", "ex_lady_rejoin_2",
	[]],
	...
	"I will do so. Please wait for a while .", "close_window",
	[
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	[anyone, "ex_lady_rejoin_2",
	[],
	"Why? I cannot. goodbye.", "close_window",
	[]],

	[anyone|plyr, "ex_lady_rejoin",
	[],
	"Nice to meet you, I leave immediately.", "close_window",
	[]],
	...
	"I am migratory birds flying the harbor.", "npc1_join_1",
	[]],
	...
	[],
	"So, what do you do?", "npc1_join_2",
	[]],

	[anyone|plyr, "npc1_join_1",
	[],
	"It is not visible to the migratory birds.", "close_window",
	[]],

	[anyone, "npc1_join_2",
	[],
	"I am a chief mate. I was detached from the group during this time.", "npc1_join_3",
	[]],

	[anyone, "npc1_join_3",
	[],
	"Admiral of the fleet was the Joan Ferrero. Joan Ferrero is a military as well as an adventurer.", "npc1_join_4",
	[]],

	[anyone, "npc1_join_4",
	[],
	"They became pirates suddenly. I have left in it to rebound. When asked why, he answers, 'Bored.' Who seems to steer his thoughts at all.", "npc1_join_5",
	[]],

	[anyone|plyr, "npc1_join_5",
	[],
	"Unusual thing. Crew is required. Let's go with me.", "npc1_join_6",
	[]],

	[anyone|plyr, "npc1_join_5",
	[],
	"I also bored.", "close_window",
	[]],

	[anyone, "npc1_join_6",
	[],
	"Are you serious? Your proposal is interesting. Of course. Why would not?", "npc1_join_7",
	[]],

	[anyone, "npc1_join_7",
	[],
	"I have attended to you. I am a chief mate, ship can move quickly.", "npc1_join_8",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	[],
	"Welcome. chief mate", "close_window",
	[]],
	...
	"Give me the money. Let's easily this work.", "npc2_join_1",
	[]],
	...
	[],
	"Cut off your head. and i give the money", "npc2_join_2",
	[]],
	...
	[anyone, "npc2_join_2",
	[],
	"If i'll living even without a head, is a fascinating proposal. Today's business was ruined. Tomorrow is also a fucking business.", "npc2_join_3",
	[]],

	[anyone, "npc2_join_3",
	[],
	"My colleagues are in jail. To extract the friend, money is needed a lot.", "npc2_join_4",
	[]],

	[anyone, "npc2_join_4",
	[],
	"I only left one person, all is difficult. I want to help a friend, but at least there is no way.", "npc2_join_5",
	[]],

	[anyone|plyr, "npc2_join_5",
	[],
	"If there is anything that you will do for me, it is possible to help you.", "npc2_join_6",
	[]],

	[anyone|plyr, "npc2_join_5",
	[],
	"You also go to prison", "close_window",
	[]],

	[anyone, "npc2_join_6",
	[],
	"You spending big. I will fight with you. Genius of making eunuch. it's me. ", "npc2_join_7",
	[]],
	...
	"As i said {reg3} Denar need to release fellows. ", "npc2_join_8",
	[]],

	[anyone|plyr, "npc2_join_8",
	[],
	"Ok. Please free the fellow in this money. Welcome.", "close_window",
	[
	...
	"Sancho. Ah? Now where to go?", "npc3_join_1",
	[]],
	...
	[anyone, "npc3_join_2",
	[],
	"Do not walk around without permission. Things to do today in many cases. There are a lot of enemies that must be beat.", "npc3_join_3",
	[]],

	[anyone, "npc3_join_3",
	[],
	"You're slow problem. Let us go as Now.", "npc3_join_4",
	[]],
	...
	[],
	"And go, where do I go?", "npc3_join_6",
	[]],

	[anyone|plyr, "npc3_join_5",
	[],
	"Old man crazy.", "close_window",
	[]],

	[anyone, "npc3_join_6",
	[],
	"I have to decide it. Come depending on where I go.", "npc3_join_7",
	[]],

	[anyone, "npc3_join_7",
	[],
	"Did you know that? So, let's go now. Sancho.", "npc3_join_8",
	[]],

	[anyone|plyr, "npc3_join_8",
	[],
	"I am not a Sancho, but as what, let's go.", "close_window",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	[anyone|plyr, "npc3_join_8",
	[],
	"I am sorry. Please go alone you.", "close_window",
	[]],
	...
	"There is no doubt that you want to know about my sword.", "npc4_join_1",
	[]],
	...
	[],
	"In fact, yes.", "npc4_join_2",
	[]],

	[anyone|plyr, "npc4_join_1",
	[],
	"I do not mind.", "close_window",
	[]],

	[anyone, "npc4_join_2",
	[],
	"When I'm walking down the forest. Giants appeared wear green armor.He disappeared by applying a sword without saying anything.", "npc4_join_3",
	[]],

	[anyone, "npc4_join_3",
	[],
	"This sword is huge, but very light. Only I have lift up sword.", "npc4_join_4",
	[]],

	[anyone, "npc4_join_4",
	[],
	"However, there is only fighting the use of a huge sword like this. So, I'm walking around looking for a battlefield.", "npc4_join_5",
	[]],

	[anyone|plyr, "npc4_join_5",
	[],
	"Then, please join me. The person who makes the battlefield is me.", "npc4_join_6",
	[]],
	...
	[anyone, "npc4_join_6",
	[],
	"Good. But now, I am a mercenary. Then, contract money is needed.", "npc4_join_7",
	[]],
	...
	" It is appropriate if perhaps about {reg3} denar.", "npc4_join_8",
	[]],

	[anyone|plyr, "npc4_join_8",
	[],
	"Understand. Welcome.", "close_window",
	[
	...
	"Why interested in me?", "npc5_join_1",
	[]],
	...
	[],
	"Because seeking fellow that together.", "npc5_join_2",
	[]],

	[anyone|plyr, "npc5_join_1",
	[],
	"Let's stop.", "close_window",
	[]],

	[anyone, "npc5_join_2",
	[],
	"I am the incompetent. Perhaps, you to talk with me, it's a waste of time.", "npc5_join_3",
	[]],

	[anyone, "npc5_join_3",
	[],
	"I was a gladiator training school Doctore.", "npc5_join_4",
	[]],

	[anyone, "npc5_join_4",
	[],
	"And, gladiators were trained. They killed their masters. So Now what should I do?", "npc5_join_5",
	[]],

	[anyone|plyr, "npc5_join_5",
	[],
	"I have asked the fellow. Doctore is also required.", "npc5_join_6",
	[]],
	...
	[anyone, "npc5_join_6",
	[],
	"I need time to think for a while.", "npc5_join_7",
	[]],

	[anyone, "npc5_join_7",
	[],
	"I'll accept your offer. I make training your soldiers.", "npc5_join_8",
	[]],

	[anyone|plyr, "npc5_join_8",
	[],
	"Welcome. Doctore.", "close_window",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	"You are a man who commanded the army. Is not it?", "npc6_join_1",
	[]],
	...
	[],
	"Yes I am such a person.", "npc6_join_2",
	[]],
	...
	[anyone, "npc6_join_2",
	[],
	"I was also a general who led the army before.", "npc6_join_3",
	[]],

	[anyone, "npc6_join_3",
	[],
	"After the defeat to the people who have never heard the names. I was wounded I almost die almost.", "npc6_join_4",
	[]],

	[anyone, "npc6_join_4",
	[],
	"However, I was saved miraculously. It is thanks to the healing art of those who Hua Tuo.", "npc6_join_5",
	[]],

	[anyone|plyr, "npc6_join_5",
	[],
	"Would you like with me? In the future,commanders are required.", "npc6_join_6",
	[]],
	...
	[anyone, "npc6_join_6",
	[],
	"My old lord was killed by Lubu.", "npc6_join_7",
	[]],

	[anyone, "npc6_join_7",
	[],
	"To punish him, the army will be needed. I'll accept your offer.", "npc6_join_8",
	[]],
	...
	"you are army commander of joseon. right?", "npc7_join_1",
	[]],
	...
	[],
	"Yes. i'm served for joseon.", "npc7_join_2",
	[]],
	...
	[anyone, "npc7_join_2",
	[],
	"Me too. I'm commander of civil army. ", "npc7_join_3",
	[]],

	[anyone, "npc7_join_3",
	[],
	"unfortunately, our civil army was defeated by Muromachi shogunate army.", "npc7_join_4",
	[]],

	[anyone, "npc7_join_4",
	[],
	"and now. I has been to recruit the volunteers.", "npc7_join_5",
	[]],

	[anyone|plyr, "npc7_join_5",
	[],
	"Would you like with me? Our army is almost ten thousand. we need aide.", "npc7_join_6",
	[]],

	[anyone|plyr, "npc7_join_5",
	[],
	"Good talking. and i'll leave.", "close_window",
	[]],

	[anyone, "npc7_join_6",
	[],
	"Of course. Exactly, It is my intent.", "npc7_join_7",
	[]],

	[anyone, "npc7_join_7",
	[],
	"too many innocent people has dying. we need move quickly.", "npc7_join_8",
	[]],

	[anyone|plyr, "npc7_join_8",
	[],
	"Okay. Welcome.", "close_window",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	[anyone, "npc9_join_2",
	[],
	"Good. Feels good friends, drinking alone is not good.", "npc9_join_3",
	[]],

	[anyone, "npc9_join_3",
	[],
	"I'm a warrior. Recently, there is no work to be done to me.", "npc9_join_4",
	[]],

	[anyone, "npc9_join_4",
	[],
	"So, it will drink and drink as this.", "npc9_join_5",
	[]],

	[anyone|plyr, "npc9_join_5",
	[],
	"If warrior like you, seems necessary to us.", "npc9_join_6",
	[]],
	...
	[anyone, "npc9_join_6",
	[],
	"You're thinking like me. When I first saw you, The smell of blood was in the air.", "npc9_join_7",
	[]],

	[anyone, "npc9_join_7",
	[],
	"I rested too long. It seems to be a movement to loosen the body soon.", "npc9_join_8",
	[]],

	[anyone|plyr, "npc9_join_8",
	[],
	"Welcome. Great warrior.", "close_window",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop")
	]],
	...
	"Nice to meet you. but it is not a good idea.", "npc11_join_1",
	[]],
	...
	[],
	"What does that mean?", "npc11_join_2",
	[]],

	[anyone|plyr, "npc11_join_1",
	[],
	"Yes. You're right.", "close_window",
	[]],

	[anyone, "npc11_join_2",
	[],
	"I am a person who has been expelled.", "npc11_join_3",
	[]],

	[anyone, "npc11_join_3",
	[],
	"I was very reliable the outside people. but this people, had to flee to kill people of our tribe.", "npc11_join_4",
	[]],

	[anyone, "npc11_join_4",
	[],
	"So, I am the one that is expelled.", "npc11_join_5",
	[]],

	[anyone|plyr, "npc11_join_5",
	[],
	"Let's go chase them.", "npc11_join_6",
	[]],
	...
	[anyone, "npc11_join_6",
	[],
	"Are you serious?  It is proposed a very attractive to me. However, you are a person outside.", "npc11_join_7",
	[]],

	[anyone, "npc11_join_7",
	[],
	"How can I trust you? Not a. However, there is no other way.  I go along to you.", "npc11_join_8",
	[]],
	...
	"Nice to meet you. Could you help me?", "npc12_join_1",
	[]],
	...
	[],
	"Let's hear what's going on.", "npc12_join_2",
	[]],
	...
	[anyone, "npc12_join_2",
	[],
	"I heard the news that Hua Tuo's dead.", "npc12_join_3",
	[]],

	[anyone, "npc12_join_3",
	[],
	"He is the master of medicine. He died have refused to teach the secrets of medicine.", "npc12_join_4",
	[]],

	[anyone, "npc12_join_4",
	[],
	"person who received the secret  is me. I must go away.", "npc12_join_5",
	[]],

	[anyone|plyr, "npc12_join_5",
	[],
	"I understand. Come on, let's start.", "npc12_join_6",
	[]],
	...
	[anyone, "npc12_join_6",
	[],
	"Thank you. I will give help in your army.", "npc12_join_7",
	[]],

	[anyone, "npc12_join_7",
	[],
	"Or if you have permission. I can give you surgery of the improved brain.", "npc12_join_8",
	[]],
	...
	"You are very strong. I was impressed .", "npc13_join_1",
	[]],

	[anyone|plyr, "npc13_join_1",
	[],
	"You too.", "npc13_join_2",
	[]],
	...
	[anyone, "npc13_join_2",
	[],
	"I have a duel many. I've been killed with the sword many enemies.", "npc13_join_3",
	[]],

	[anyone, "npc13_join_3",
	[],
	"So, There are many who have a grudge against me. I would think i should go on a journey .", "npc13_join_4",
	[]],

	[anyone, "npc13_join_4",
	[],
	"to avoid resentment? No. I'm not afraid of them. My concern is the lack of my rival. Perhaps you will be able to help me .", "npc13_join_5",
	[]],

	[anyone|plyr, "npc13_join_5",
	[],
	"I understand. you will fight by my side .", "npc13_join_6",
	[]],
	...
	[anyone, "npc13_join_7",
	[],
	"Travel is also a good. I wonder, My sword will be useful in different worlds.", "npc13_join_8",
	[]],

	[anyone|plyr, "npc13_join_8",
	[],
	"Welcome. Great Swordman", "close_window",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop"),
		(call_script, "script_wm_finish_mission_menu_popup", "mnu_wm_quest_menu")
	...
	"Before I die, I have suggestions.", "npc14_join_1",
	[]],

	[anyone|plyr, "npc14_join_1",
	[],
	"What suggestions?", "npc14_join_2",
	[]],

	[anyone|plyr, "npc14_join_1",
	[],
	"I do not want to hear.", "close_window",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(change_screen_return)
	]],
	...
	[anyone, "npc14_join_2",
	[],
	"If you get me alive, i give you great help.", "npc14_join_3",
	[]],
	...
	[anyone, "npc14_join_4",
	[],
	"I am sure you will be need my skill.", "npc14_join_5",
	[]],

	[anyone|plyr, "npc14_join_5",
	[],
	"Assassin. Seems to be helpful. go with me.", "npc14_join_6",
	[]],
	...
	[anyone, "npc14_join_6",
	[],
	"Good deal.", "npc14_join_7",
	[]],

	[anyone, "npc14_join_7",
	[],
	"My specialty is assassination, agitation and disturbance. Needless to say, more of that?", "npc14_join_8",
	[]],

	[anyone|plyr, "npc14_join_8",
	[],
	"Welcome. Assasin", "close_window",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(call_script, "script_wm_comp_in_party_slot", "$g_talk_troop"),
		(change_screen_return)
	...
	[anyone|plyr, "npc14_join_8",
	[],
	"My opinion has changed.", "close_window",
	[
		(troop_set_slot, "$g_talk_troop", 15, 1),
		(change_screen_return)
	]],
	...
	[anyone, "start",
	[],
	"if you seen this message, bug report please.", "close_window",
	[]],
	...
	"I would throw away the nationality. and I hope join to your country. can you help me?", "lord_player_betray_1",
	[]],
	...
	[],
	"There are no need to talk. Prepare to die!", "close_window",
	[
	...
	[anyone|plyr, "caravan_master_talk",
	[],
	"Please show me a thing of your country .", "caravan_master_trade",
	[]],
