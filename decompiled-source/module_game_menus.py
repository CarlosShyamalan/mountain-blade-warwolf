...
game_menus = [
	...
	("start_game_0", menu_text_color(0xff000000), "-Warwolf-",
"none",
	[
	...
	("start_phase_2", 0, "One day. The great war occurred in your homeland. The war has killed your parents.^your only family is little sister. You have participated in the war for revenge.^but your little sister was remain to village.",
"none",
	[
...
"none",
	...
	("start_phase_x3", 0, "The great war has ended . However, dead parents did not come back.^You come back to the village, and greatly surprised.^village was looted, your little sister was disappeared.^You have been fought against the world for two years to find your last family member.^^the passage of time. You were looking around yourself.",
"none",
	[
...
"none",
	[
		...
		(else_try),
			...
			(try_begin),
				...
				(party_set_slot, "p_main_party", slot_town_elder, 70),
				(party_set_slot, "p_main_party", slot_center_player_relation, 70),
			(try_end),
			(try_for_range, ":troop", "trp_elite_troops_01", "trp_elite_troops_end"),
				(call_script, "script_outfit_weapon_set_no_agent", "$current_town", ":troop"),
				(call_script, "script_bandit_outfit_setting_no_agent", "$current_town", ":troop"),
	...
	("start_phase_3", 0, "{s16}^^You are walking down the street in {s1}, Suddenly, the woman scream was heard. You grasped the weapon in hand.",
"none",
	[],
	[
		("continue",
...
"none",
	...
	("end_game", 0, "Thank you for playing this MOD.^^     -Feodor Gerasimov & Molda",
"none",
	[],
	[
		("end_game_bye",
	...
	("wm_wedding_menu", 0, "Wishing You God's Blessing on Your Wedding Day...^...and may He always be the heart of your marriage,^the light of your home,^and the ever-present partner in your life together.^Congratulations",
"none",
	[
	...
	("wm_other_wedding", 0, "Messenger was pass to the news to you. {s7} and {s8} got married.",
"none",
	[
...
"none",
	...
	[
		...
		"Ruins: Dialogue with monks of temple.",
		[
		...
		"Ruins: Walks over to the Sphinx.",
		[
	...
	("Sphinx_question", 0, "Stop! 'What walks on three legs in the morning, two legs at noon and three at night?'  If you do not match the correct answer, you will live as slave forever.",
"none",
	[
	...
	("Sphinx_question_2", 0, "{s18}^^Damn. You win.  As reward. I will tell you some wisdom to you.",
"none",
	[
		(set_background_mesh, "mesh_1pic_ruin_21")
	],
	...
	("Sphinx_wrong", 0, "Wrong!!^^^^-Game over-^^You will live as slaves of Sphinx forever.",
"none",
	[
		(set_background_mesh, "mesh_1pic_ruin_21")
	],
...
"none",
	...
	("encount_ghost_ship", 0, "Fog occurs suddenly. We cannot see anything.  After a while. You saw it. It was a ship that was almost destroyed. How could that ship floating on the sea?",
"none",
	[
...
"none",
	...
	("bewanderer", 0, "Abandon everything and become wanderer.",
"none",
	[
		(set_background_mesh, "mesh_pic_siege_sighted")
	],
	...
	("wm_bank_menu", 0, "Banker: Greetings, what is your need?^^Remaining month of repayment: {reg11}^Repayment cash per month: {reg12}^Savings: {reg13}",
"none",
	[
		(try_begin),
	...
	("coup_success", 0, "You succeed coup. Enemy has surrendered or fled . and now, It is time to notify everyone what you suggest.",
"none",
	[
	...
	[
		("monarchy",
		[],
		"I will be ruled the country by monarchy.",
		[
			(faction_get_slot, ":wm_player_fac_29", "$wm_player_fac", 29),
			(try_for_range, ":party", "p_pyongyang", "p_place_end"),
				(store_faction_of_party, ":faction_of_party_party", ":party"),
		...
		("republic",
		[],
		"We will be ruled the country by republic.",
		[
			(faction_get_slot, ":wm_player_fac_29", "$wm_player_fac", 29),
			(try_for_range, ":party", "p_pyongyang", "p_place_end"),
				(store_faction_of_party, ":faction_of_party_party", ":party"),
	...
	("coup_fail", 0, "You failed coup. supporters will be scattered. and you have barely alive.",
"none",
	[
		(play_track, "track_frustrated", 2),
		(set_background_mesh, "mesh_pic_defeat"),
		(assign, "$attempt_coup", 0),
		(assign, "$wm_battle_result_state", 0)
	],
	...
	("coup_view", 0, "Your supporter: {reg9}^Required supporter: {reg7}^Lords Sum: {reg8}^^{s11}",
"none",
	[
		(set_background_mesh, "mesh_pic_siege_sighted"),
	...
	("coup_progress", 0, "{s12}^^Enemy Commander : {s7}^^Army Size : Enemy {reg8} vs {reg11} Player^Training : Enemy {reg9} vs {reg12} Player^Morale : Enemy {reg10} vs {reg13} Player^Spawn Limit {reg16}^Enemy {reg14} vs {reg15} Player",
"none",
	[
		(assign, "$wm_battle_result_state", 0),
		(try_begin),
			...
			(call_script, "script_party_army_size_execute", "p_exparty_backup", 4000, 5),
		...
		(else_try),
			...
			(try_end),
			(party_set_faction, "p_exparty_backup", "$wm_player_fac"),
			(call_script, "script_party_army_size_execute", "p_exparty_backup", 7000, 5),
...
"none",
	...
	("mess_we_know", 0, "You have found a strange paper from pocket of pants. you can't believe that.",
"none",
	[
	...
	("we_know_assassination", 0, "You are woken up, because feeling strange.^^Suddenly, black outfit assassin was infiltrate.",
"none",
	[
		(set_background_mesh, "mesh_pic_weknow")
	],
...
"none",
	...
	("blank_encounter", 0, "You stand between battle. What is your choice?",
"none",
	[
		(store_random_in_range, ":random_in_range_0_2", 0, 2),
		(party_get_current_terrain, ":current_terrain_main_party", "p_main_party"),
...
"none",
	...
	("wm_player_prisoner", 0, "You were imprisoned by the enemy.^Enemy was given to you the chance of selection.",
"none",
	[
		(assign, "$is_prisoner", 0),
	...
	[
		("wm_bribe_capture",
		[],
		"Negotiate : Paying 3/4 of wealth.",
		[
			(store_mul, ":value", 500, 10),
			(try_begin),
				(call_script, "script_party_money_level_ge", "p_main_party", ":value"),
		...
		("wm_loooted",
		[],
		"Surrender : Give to them every saleable equipments.",
		[
			(try_begin),
				(call_script, "script_party_money_level_set_percent", "p_main_party", 25),
				(call_script, "script_initialize_main_party"),
...
"none",
	...
	[
		...
		"[Find the clue about catholic kingdom.]",
		[
		...
		"[Wait until the letter sender has tried to contact.]",
		[
	...
	("wm_visit_tradeguild", 0, "Trade guild has provide information to you. for this job, you need little money.^1. Click [Trade Info]^2. Return to World Map^3. Castle Right-Click Menu^4. Click -Trade Info-",
"none",
	[
		(set_background_mesh, "mesh_pic_bank_back")
	],
	[
		...
		"Talk with master, about your sister.",
		[
...
"none",
	...
	[
		...
		"Participate to the fight (Round {reg7}/3)",
		[
			(assign, "$wm_duel_persnal", 0),
			(assign, "$wm_battle_result_state", 0),
			(assign, "$wm_duel_won", 0),
	...
	("wm_troop_clear", 0, "[Size initialize]: every 'Army' troops will get fired. except companion, elite troop, common troop.",
"none",
	[],
	[
		("troop_clear",
		[],
		"[Main army initialize]",
		[
			(call_script, "script_wm_simp_tr_init"),
			(jump_to_menu, "mnu_wm_pst_map_return")
		], "."),
	...
	("wm_wastland", 0, "This is wasteland. Build new village is required 50000 people. and 25000 Denars.^^Current Population {reg7}/50000",
"none",
	[
		(store_random_in_range, ":random_in_range_0_2", 0, 2),
		(party_get_current_terrain, ":current_terrain_main_party", "p_main_party"),
...
"none",
	...
	("wm_game_over", 0, "Your head is falling down to the ground. you can't see the dark. even you can't think about dark.^(System: Enemy commander is one of your foe. if you defeated in battle, and failed to escape, you will die.)",
"none",
	[
		(play_track, "track_frustrated", 2),
...
"none",
	...
	("wm_ply_hideout", 0, "It is your secret mansion.",
"none",
	[
...
"none",
	...
	("wm_brothel", 0, "Income prev month: {reg11}^Member List:^ {s11}^ {s12}^ {s13}^ {s14}^ {s15}^ {s16}^ {s17}",
"none",
	[
		(play_track, "track_love_scene", 2),
		(set_background_mesh, "mesh_pic_xex14"),
...
"none",
	...
	("pirate_king", 0, "You've conquered all the seas of the world. ^^Bonus:^Sea battle ship spawn +1^Ship maintenance cost 66% decrease^Blackship blueprint^Pirate king pistol",
"none",
	[
...
"none",
	...
	("for_quest_villa", 0, "This place is the villa of noble.",
"none",
	[
		(set_background_mesh, "mesh_pic_xex14")
	],
	...
	("wanted_named_pirate", 0, "-Wanted-^Dead or Alive^Looter of sea. Fearsome pirate {s8}.^Reward: Alive 15000 / Dead 7500 denars^^by the name of Harbor master",
"none",
	[
		(set_fixed_point_multiplier, 1000),
	...
	("jailbreak_enter", 0, "You got the key of the prison.",
"none",
	[
		(set_background_mesh, "mesh_pic_prisoner_man")
	],
...
"none",
	...
	("ply_rel_nogod", 0, "Abandon your religion. Are you sure?",
"none",
	[],
	[
		("ply_rel_nogod_yes",
...
"none",
	...
	[
		...
		"I will distribute the money to the fellow .",
		[
		...
		"kill the old man,  and take away a book.",
		[
			(call_script, "script_wm_honor_change_diff", "trp_player", 5, 34),
			(store_random_in_range, ":random_in_range_1081_1252", 1081, 1252),
			(troop_add_item, "trp_player", ":random_in_range_1081_1252"),
		...
		"I make a duel in order to restore my honor .",
		[
...
"none",
	[
		...
		(else_try),
			(eq, "$main_q_step", 97),
			(set_background_mesh, "mesh_main_menu_background"),
